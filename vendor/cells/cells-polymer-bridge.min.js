    ...
    function (e, t, n) {
      ...
      function r(e) {
        for (var t = e.split("."), n = [], r = 0; r < t.length; r++) {
          for (var i = t[r]; "\\" === i[i.length - 1] && void 0 !== t[r + 1]; )
            (i = i.slice(0, -1) + "."), (i += t[++r]);
          n.push(i);
        }
        return n;
    ...
    function (e, t, n) {
      ...
      function y(e, t) {
        return new Promise(function (n, r) {
          ...
          g(e, t, o, { once: !0 }), "error" !== t && d(e, i, { once: !0 });
        });
      }
      function d(e, t, n) {
      ...
      Object.defineProperty(i, "defaultMaxListeners", {
        ...
        (i.prototype.emit = function (e) {
          ...
          if ("function" == typeof u) w(u, this, t);
          else
            for (var s = u.length, c = p(u, s), n = 0; n < s; ++n)
              w(c[n], this, t);
          return !0;
        }),
    ...
    function (e, t, n) {
      !(function (t, n) {
        ...
        function n() {
          ...
          function t(e, t, n, r) {
            var o = t && t.prototype instanceof i ? t : i,
              ...
              u = new h(r || []);
            return b(a, "_invoke", { value: c(e, n, u) }), a;
          }
          function r(e, t, n) {
            try {
          ...
          function c(e, t, n) {
            ...
            return function (o, a) {
              ...
              for (n.method = o, n.arg = a; ; ) {
                ...
                var c = r(e, t, n);
                if ("normal" === c.type) {
                  if (((i = n.done ? O : k), c.arg === T)) continue;
          ...
          var A = Object.getPrototypeOf,
            j = A && A(A(v([])));
          j && j !== g && m.call(j, E) && (x = j);
          var I = (a.prototype = i.prototype = Object.create(x));
          return (
            (o.prototype = a),
            b(I, "constructor", { value: a, configurable: !0 }),
            b(a, "constructor", { value: o, configurable: !0 }),
            (o.displayName = e(a, S, "GeneratorFunction")),
            ...
            (d.mark = function (t) {
              return (
                Object.setPrototypeOf
                  ...
                  : ((t.__proto__ = a), e(t, S, "GeneratorFunction")),
            ...
            u(s.prototype),
            e(s.prototype, _, function () {
              return this;
            }),
            (d.AsyncIterator = s),
            (d.async = function (e, n, r, i, o) {
              void 0 === o && (o = Promise);
              var a = new s(t(e, n, r, i), o);
              return d.isGeneratorFunction(n)
                ? a
        ...
        function E(e) {
          function t() {
            for (
              var i = this, o = arguments.length, a = new Array(o), u = 0;
              u < o;
              u++
            )
              a[u] = arguments[u];
        ...
        var _,
          ...
          k = {
            ...
            REQUIRED_FIELDS: C,
            ALLOWED_FIELDS: [].concat(C, ["identifier", "version", "logLevel"]),
          },
          P = function (e) {
            return function (t, n, r) {
              return "https://"
                .concat(e, ".")
                .concat([t, n].filter(Boolean).join("."), "/")
                .concat(r);
            };
          },
          O = {
          ...
          x = {
            ...
            REQUIRED_FIELDS: [],
            LOG_LEVELS: [T, "info", "warn", "warning", "error", "fatal"],
          },
          A = { SEMAAS: k, RHO: O, OMEGA: x },
          j = function (e) {
            var t = "_",
              n = {},
              i = function e(i, o) {
          ...
          I = function (e, n) {
            ...
            return (
              Object.keys(r).forEach(function (e) {
                n.includes(e) || delete r[e];
              }),
              r.properties && (r.properties = j(r.properties)),
              r
            );
          },
          R = function (e) {
          ...
          N = function (e, t) {
            return e.reduce(function (e, n) {
              ...
              return i ? i.values.push(n) : e.push({ key: r, values: [n] }), e;
            }, []);
          },
          M = function () {
          ...
          F = A.OMEGA,
          B = F.DEFAULT_LOG_LEVEL,
          U = F.ALLOWED_FIELDS,
          G = D.sanitizeObj,
          H = (function () {
            function e(t) {
              a(this, e), (this.mrId = t);
            }
            return (
              s(e, [
                {
                  ...
                  value: function (e) {
                    var n = this.mrId,
                      r = G(e, U),
                      i = { mrId: n, creationDate: 1e6 * Date.now(), level: B };
                    return t(t({}, i), r);
                  },
                },
              ]),
          ...
          Y = (function () {
            function e(t) {
              a(this, e), (this.spanId = null), this.initialize(t);
            }
            return (
              s(e, [
                {
                ...
                },
                {
                  ...
                  value: function (e, n) {
                    var r = this.mrId,
                      ...
                      o = void 0 === i ? r : i,
                      a = e.parentSpan,
                      u = this.getParentSpan(a, o, n),
                      s = t(t({}, e), {}, { mrId: o, parentSpan: u }),
                      c = new Y(s);
                    return c;
                  },
                },
          ...
          ee = { outerDecorator: w, decorate: Z },
          te = D.groupBy,
          ne = 1e3,
          re = (function () {
            function e(t) {
              a(this, e), (this.items = []), (this.identifier = t);
            }
            return (
              s(e, [
                {
                  ...
                  value: function (e, t) {
                    var n = this,
                      r = Array.isArray(t) ? l(t) : [t];
                    r.forEach(function (t) {
                      var r = { data: t, endpoint: e };
                      n.items.push(r);
                    });
                  },
                },
                {
                  ...
                  value: function () {
                    ...
                    return (
                      console.log(
                        "Dumping "
                          .concat(n.length, " items from ")
                          .concat(this.identifier, " queue (")
          ...
          oe = J.Rho,
          ae = A.SEMAAS,
          ue = ae.REQUIRED_FIELDS,
          se = ae.ALLOWED_FIELDS,
          ce = ae.DEFAULT_ADAPTER_IDENTIFIER,
          le = ae.DEFAULT_ADAPTER_VERSION,
          fe = A.OMEGA,
          pe = fe.HOST,
          he = fe.DEFAULT_LOG_LEVEL,
          ve = fe.LOG_LEVELS,
          ye = A.RHO.HOST,
          de = D.hasProperties,
          ge = ee.outerDecorator,
          me =
            ((_ = ge(5e3)),
            (S = (function () {
              function e(t) {
                ...
                s(e, [
                  {
                    key: "setup",
                    value: function (e) {
                      if (!e || !this.validateConfig(e, ue))
                        throw new Error(
                          "Invalid setup for SEMaaS adapter ("
                            .concat(this.identifier, "). Required fields: ")
                            .concat(ue.join(", "), ".")
                        );
                      this.initialize(e);
                    },
                      ...
                      (this.omega = new ie(i)),
                        ...
                        console.info(
                          "SEMaaS adapter for "
                            ...
                            .concat(n, ", mrId: ")
                            .concat(i, ") [logLevel: ")
                            .concat(c, "] [tsecStorageKey: ")
                            .concat(l, "] successfully initialized.")
                        );
                    },
                  },
                  {
                    ...
                    value: function (e) {
                      ...
                      this.shouldIncludeLog(t.level, this.logLevel) &&
                              ...
                              for (;;)
                                switch ((e.prev = e.next)) {
                                  ...
                                  case 8:
                                    ...
                                    console.log(
                                      "There was a problem while sending data to SEMaaS - operation will be queued."
                                    ),
                                      this.enqueue(t, r),
                                      (e.next = 15);
                                    break;
                          ...
                          return n().wrap(
                            function (e) {
                              for (;;)
                                switch ((e.prev = e.next)) {
                                  case 0:
                                    return (e.next = 2), this.getRequestData();
                                  case 2:
                                    if ((t = e.sent)) {
                                      e.next = 5;
                                      break;
                                  ...
                                  case 5:
                                    (r = t.endpoint),
                                      ...
                                      this.send(r, i, o)
                                        .then(function () {
                                          return a.queue.any() && a.flush();
                                        })
                                        .catch(function (e) {
                                          console.error(
                                            "There was a problem while sending data to SEMaaS - ".concat(
                                              e.message
                                            )
                                          );
                                        });
                                ...
                                switch ((e.prev = e.next)) {
                                  ...
                                  case 5:
                                    return (
                                      ...
                                      e.abrupt(
                                        "return",
                                        this.send(r, i, o).catch(function (e) {
                                          console.error(
                                            "There was a problem while sending data to SEMaaS - ".concat(
                                              e.message
                                            )
                            ...
                            function (e) {
                              for (;;)
                                switch ((e.prev = e.next)) {
                                  case 0:
                                    return (
                                      (e.next = 2), this.ensureValidApiKey()
                                    );
                                  case 2:
                                    if ((t = e.sent)) {
                                      e.next = 6;
                                    ...
                                    return (
                                      console.log(
                                        "No valid API Key for SEMaaS adapter (".concat(
                                          this.identifier,
                                          ") - aborting operation"
                                        )
                                      ),
                                  ...
                                  case 6:
                                    if ((r = this.queue.dump())) {
                                      e.next = 10;
                                      break;
                                    }
                                    return (
                                      console.log(
                                        "Empty queue for SEMaaS adapter (".concat(
                                          this.identifier,
                                          ")"
                                        )
                                      ),
                              ...
                              for (;;)
                                switch ((e.prev = e.next)) {
                                  ...
                                  case 3:
                                    ...
                                    return (
                                      console.log(
                                        "ApiKey KO, Credentials OK -> getApiKey()"
                                      ),
                                      e.abrupt("return", this.getApiKey())
                                    );
                                  case 6:
                                    return (
                                      console.log(
                                        "No ApiKey && No Credentials -> KO"
                                      ),
                                      e.abrupt("return", !1)
                                    );
                                  case 8:
                  ...
                  },
                  {
                    ...
                    value: function () {
                      ...
                      switch (this.version.toLowerCase()) {
                        case "v1":
                          (e = "Authorization"),
                            (t = "Bearer ".concat(this.apiKey));
                          break;
                        default:
                          (e = "Api-Key"), (t = "jwt ".concat(this.apiKey));
                      }
                      return c({}, e, t);
                    },
                  },
                                ...
                                switch ((e.prev = e.next)) {
                                  case 0:
                                    return (
                                      (t = this.consumerId),
                                      (r = this.policy),
                                      (i = this.tsec2JWTEndpoint),
                                      (o = {
                                        "x-consumer-id": t,
                                        "x-tsec-token": this.tsec,
                                        "x-validation-policy": r,
                                      }),
                                      (a = i),
                                      (e.next = 5),
                                      $.get(a, o)
                  ...
                  },
                  {
                    ...
                    get: function () {
                      var e = this.nameSpace,
                        t = this.getEndpoint(pe);
                      return "".concat(t, "/ns/").concat(e, "/logs");
                    },
                  },
                  {
                    key: "rhoEndpoint",
                    get: function () {
                      var e = this.nameSpace,
                        t = this.getEndpoint(ye);
                      return "".concat(t, "/ns/").concat(e, "/spans");
                    },
                  },
                  {
                    key: "prefixForChildSpan",
                    get: function () {
                      return "ns/".concat(this.nameSpace, "/mrs");
                    },
                  },
                  {
                    key: "tsec",
                    ...
                    value: function (e) {
                      var t =
                          arguments.length > 1 && void 0 !== arguments[1]
                            ...
                            : he,
                        n = function (e) {
                          return ve.indexOf(e.toLowerCase());
                        },
                        r = n(e),
                        i = n(t);
                      return r >= i;
            ...
            m(
              ...
              "flush",
              [_],
              Object.getOwnPropertyDescriptor(S.prototype, "flush"),
              S.prototype
            ),
            S);
        return me;
            ...
            return (
              (function e(r, i) {
                ...
                try {
                  for (a.s(); !(o = a.n()).done; ) {
                    var u = o.value;
                    Array.isArray(u) && i > 0 ? e(u, i - 1) : t.push(u);
                  }
                } catch (e) {
                  a.e(e);
                } finally {
    ...
    function (e, t, n) {
      ...
      function te() {
        ...
        function t(e, t, n, i) {
          var o = t && t.prototype instanceof r ? t : r,
            a = Object.create(o.prototype),
            u = new p(i || []);
          return m(a, "_invoke", { value: s(e, n, u) }), a;
        }
        function n(e, t, n) {
          try {
            return { type: "normal", arg: e.call(t, n) };
        ...
        function u(e, t) {
          function r(i, o, a, u) {
            ...
            if ("throw" !== s.type) {
              var c = s.arg,
                l = c.value;
              return l && "object" == ee(l) && g.call(l, "__await")
                ? t.resolve(l.__await).then(
                    function (e) {
                      r("next", e, a, u);
                    },
          ...
          return function (o, a) {
            ...
            for (r.method = o, r.arg = a; ; ) {
              ...
              if ("next" === r.method) r.sent = r._sent = r.arg;
                ...
                if (i === S) throw ((i = P), r.arg);
                r.dispatchException(r.arg);
              } else "return" === r.method && r.abrupt("return", r.arg);
              i = k;
              var l = n(e, t, r);
              if ("normal" === l.type) {
                if (((i = r.done ? P : C), l.arg === O)) continue;
                return { value: l.arg, done: r.done };
              }
              "throw" === l.type &&
                ((i = P), (r.method = "throw"), (r.arg = l.arg));
            }
          };
        }
        function c(e, t) {
          ...
          var o = n(i, e.iterator, t.arg);
          if ("throw" === o.type)
            return (
              (t.method = "throw"), (t.arg = o.arg), (t.delegate = null), O
            );
          var a = o.arg;
          return a
            ? a.done
        ...
        var x = Object.getPrototypeOf,
          A = x && x(x(h([])));
        A && A !== d && g.call(A, w) && (T = A);
        var j = (o.prototype = r.prototype = Object.create(T));
        return (
          (i.prototype = o),
          m(j, "constructor", { value: o, configurable: !0 }),
          m(o, "constructor", { value: i, configurable: !0 }),
          (i.displayName = e(o, _, "GeneratorFunction")),
          ...
          (y.mark = function (t) {
            return (
              Object.setPrototypeOf
                ...
                : ((t.__proto__ = o), e(t, _, "GeneratorFunction")),
          ...
          a(u.prototype),
          e(u.prototype, E, function () {
            return this;
          }),
          (y.AsyncIterator = u),
          (y.async = function (e, n, r, i, o) {
            void 0 === o && (o = Promise);
            var a = new u(t(e, n, r, i), o);
            return y.isGeneratorFunction(n)
              ? a
              : a.next().then(function (e) {
                  return e.done ? e.value : a.next();
                });
      ...
      function ve(e) {
        return e.reduce(function (e, t) {
          return e.concat(t instanceof Wo ? t.errors : t);
        }, []);
      }
      function ye(e) {
        for (; e; ) {
      ...
      function de(e, t, n) {
        ...
        return e || t || n ? new Jo(e, t, n) : new Jo(Vo);
      }
      function ge(e) {
        return e;
      }
      ...
      function Ee(e, t, n, r) {
        return (
          ...
          r
            ? Ee(e, t, n).pipe(
                we(function (e) {
                  return zo(e) ? r.apply(void 0, e) : r(e);
                })
              )
            : new Xo(function (r) {
                function i(e) {
      ...
      function _e(e, t, n, r, i) {
        ...
        if (ke(e)) {
          ...
          e.addListener(t, n),
            (o = function () {
              return s.removeListener(t, n);
            });
        } else {
          if (!e || !e.length) throw new TypeError("Invalid event target");
          for (var c = 0, l = e.length; c < l; c++) _e(e[c], t, n, r, i);
        }
        r.add(o);
      }
      function Se(e) {
          ...
          return (
            r.add(
              t.schedule(function () {
                return i === e.length
                  ? void n.complete()
                  : (n.next(e[i++]), void (n.closed || r.add(this.schedule())));
              })
            ),
            r
          );
      ...
      function je(e, t) {
        return t ? Ae(e, t) : new Xo(ma(e));
      }
      function Ie() {
        for (var e = [], t = 0; t < arguments.length; t++) e[t] = arguments[t];
        var n = e[e.length - 1];
        return xe(n) ? (e.pop(), Ae(e, n)) : je(e);
      }
      function Re(e, t) {
        return new Xo(
          t
            ? function (n) {
                return t.schedule(Le, 0, { error: e, subscriber: n });
              }
            : function (t) {
                return t.error(e);
              }
      ...
      function rn(e) {
        return e && "function" == typeof e[Qa];
      }
      function on(e, t) {
        if (null != e) {
          if (nn(e)) return Zt(e, t);
          if (Xt(e)) return en(e, t);
          if (Za(e)) return Ae(e, t);
          if (rn(e) || "string" == typeof e) return tn(e, t);
        }
        throw new TypeError(
      ...
      function an(e, t) {
        return t ? on(e, t) : e instanceof Xo ? e : new Xo(eu(e));
      }
      function un(e, t) {
        if (!t.closed) {
          if (e instanceof Xo) return e.subscribe(t);
          var n;
          try {
            n = eu(e)(t);
          } catch (e) {
      ...
      function sn(e, t, n) {
        return (
          ...
          "function" == typeof t
            ...
            : ("number" == typeof t && (n = t),
              function (t) {
                return t.lift(new ru(e, n));
              })
        );
      }
      function cn(e) {
        return void 0 === e && (e = Number.POSITIVE_INFINITY), sn(ge, e);
      }
      function ln() {
        for (var e = [], t = 0; t < arguments.length; t++) e[t] = arguments[t];
        ...
        return (
          ...
          null === r && 1 === e.length && e[0] instanceof Xo
            ? e[0]
            : cn(n)(je(e, r))
        );
      }
      ...
      function Kn(e, t) {
        for (var n = 0; n < t.length; n++) {
          ...
          (r.enumerable = r.enumerable || !1),
            (r.configurable = !0),
            "value" in r && (r.writable = !0),
            Object.defineProperty(e, Qn(r.key), r);
        }
      }
      function Jn(e, t, n) {
        return (
      ...
      function ri() {
        ...
        function u(e, t) {
          function r(i, o, a, u) {
            ...
            if ("throw" !== s.type) {
              var c = s.arg,
                l = c.value;
              return l && "object" == ti(l) && g.call(l, "__await")
                ? t.resolve(l.__await).then(
                    function (e) {
                      r("next", e, a, u);
                    },
        ...
        /*! regenerator-runtime -- Copyright (c) 2014-present, Facebook, Inc. -- license (MIT): https://github.com/facebook/regenerator/blob/main/LICENSE */ ri =
          function () {
            return y;
          };
        var v,
      ...
      function gi(e, t) {
        var n = mi(),
          ...
          i = e.node[Fa] || gs;
        return (
          Object.defineProperty(e.node, Fa, {
            value: function () {
              return wi(e, t, i);
            },
          }),
          r.connections && r.connections.in
            ? yi(r.connections.in, n.in)
            : r.connections
            ? yi(r.connections, n)
            : (r.connections = n),
          Ba.set(e.node, e.node[Fa]()),
          e
        );
      }
      function mi() {
        return { in: pi({}, Da, { bind: Fa }) };
      }
      function bi(e, t) {
      ...
      function wi(e, t, n) {
        var r = t.featureFlagCollection,
          ...
          u = e.spec.connections;
        if (a) i._updateInConnections(e.node, u.in);
        else if (i.subscriptors.has(e.node)) {
          var s = Object.keys(u.in).filter(function (e) {
            return e !== Da;
          });
          i.unsubscribe(s, e.node);
        }
        return Ba.set(e.node, a), a;
      }
      function Ei(e) {
        "@babel/helpers - typeof";
        return (Ei =
      ...
      function Si(e, t) {
        for (var n = 0; n < t.length; n++) {
          ...
          (r.enumerable = r.enumerable || !1),
            (r.configurable = !0),
            "value" in r && (r.writable = !0),
            Object.defineProperty(e, ki(r.key), r);
        }
      }
      function Ci(e, t, n) {
        return (
        ...
        function u(e, t) {
          function r(i, o, a, u) {
            ...
            if ("throw" !== s.type) {
              var c = s.arg,
                l = c.value;
              return l && "object" == Vi(l) && g.call(l, "__await")
                ? t.resolve(l.__await).then(
                    function (e) {
                      r("next", e, a, u);
                    },
      ...
      var eo,
        ...
        ro = { DEFAULT: no.ALWAYS, VALUES: Object.values(no) },
        io = {
        ...
        yo = { DEFAULT: vo.DEFER, VALUES: Object.values(vo) },
        go = { WORKING: "working", REQUESTED: "requested" },
        mo = { LIT_ELEMENT: "litElement", POLYMER: "polymer" },
        bo = { STATIC: "static", DYNAMIC: "dynamic" },
        wo = {
          bindingCodes: no,
          binding: ro,
          componentsPath: ao,
        ...
        Po = function (e) {
          return function (t) {
            return So(t) ? ko(e)(t) : Array.isArray(t) ? Co(e)(t) : [];
          };
        },
        Oo = ["ambient", "variant", "disabled"],
        To = function (e, t, n) {
          "boolean" == typeof n
            ? n
              ? e.setAttribute(t, "")
        ...
        xo = {
          ...
          camelize: _o,
          findProperty: Po,
          attributeWhiteList: Oo,
          setAttribute: To,
        },
        Ao = wo.externalEventsCodes,
        jo = (function () {
          function e() {
            S(this, e);
          }
          return (
            k(e, [
              ...
              },
              {
                key: "setProps",
                value: function (e, t, n) {
                  var r = Ao.BEFORE_SET_ATTR_TO_NODE,
                    i = Ao.AFTER_SET_ATTR_TO_NODE;
                  t &&
                    "object" === _(t) &&
                    (to.emit(r, e.tagName),
                    Object.keys(t).forEach(function (r) {
                      n === mo.LIT_ELEMENT && Oo.includes(r)
                        ? To(e, r, t[r])
                        : (e[r] = t[r]);
                    }),
                    to.emit(i, e));
              ...
              },
              {
                key: "createElement",
                value: function (e, t, n) {
                  var r = Ao.BEFORE_CREATE_NODE,
                    i = Ao.AFTER_CREATE_NODE;
                  to.emit(r, e);
                  var o = document.createElement(e);
                  return to.emit(i, o), t && this.setProps(o, t, n), o;
                },
              },
            ]),
            e
        ...
        Lo = (function () {
          function e(t) {
            A(this, e),
              (this.prefix = ""),
              (this.persistent = !1),
              (this.internalStorage = new Ro()),
              T(this, t),
              this.persistent && this.clear();
          }
          return (
            I(e, [
              {
            ...
            F(e, [
              {
                ...
                value: function (e, t) {
                  return new Promise(function (n, r) {
                    ...
                    if (!e || !e.url)
                      return void r(new Error("URL not defined"));
                    var o = (e.method || "").toUpperCase() || "GET";
                    i.addEventListener("load", function (e) {
                      var i = e.target,
                        o = i.status;
                      (o >= 200 && o < 300) ||
                      (0 == o && i.responseText.length > 0)
                        ? n(
                            "json" === t
                    ...
                    var a = e.headers;
                    for (var u in a)
                      a.hasOwnProperty(u) && i.setRequestHeader(u, a[u]);
                    i.send(e.body);
                  });
                },
              },
            ...
            $(e, [
              {
                ...
                value: function (e) {
                  ...
                  return this._parseConnections(y);
                },
              },
              {
                key: "parse",
              ...
              },
              {
                ...
                value: function (e) {
                  return H(
                    { properties: { cellsConnections: { in: {}, out: {} } } },
                    e
                  );
                },
              },
                ...
                value: function (e) {
                  ...
                  for (var n in e)
                    if (e.hasOwnProperty(n)) {
                      var r = e[n],
                        i = Eo(n) + "-changed";
                      (t.in[r] = this._createConnection(n)),
                        (t.out[r] = this._createConnection(i));
                    }
                  return t;
                },
              },
        ...
        Fo = wo.externalEventsCodes,
        Bo = (function () {
          function e(t) {
            oe(this, e), this._initCellsPageManager(t);
          }
          return (
            ue(e, [
              {
                ...
                value: function (e) {
                  var t = e.htmlPagesPath,
                    ...
                    f = e.composerEngine,
                    p = e.TemplateManager,
                    h = new Lo({ prefix: l, persistent: c }),
                    v = new No(),
                    y = new Do();
                  ie(this, {
                    storage: h,
              ...
              },
              {
                ...
                value: function (e) {
                  ...
                  return (
                    this.getPlatform &&
                      (t = t.replace(/{platform}/, this.getPlatform())),
                    (t = t.replace(/{page}/, e))
                  );
                },
              },
              {
                key: "_localTemplate",
                value: function (e) {
                  var t = this.templatesPath
                    ? this.templatesPath
                    : this.composerEndpoint;
              ...
              },
              {
                ...
                value: function (e) {
                  ...
                  return (t = i
                    ? 0 !== this.composerEndpoint.indexOf("http")
                    : !this.composerEndpoint ||
                      !this.remoteTemplates ||
                      this.remoteTemplates.indexOf(e) < 0);
                },
              },
              {
                key: "_renderComposerEndpoint",
                value: function (e) {
                  return this._isLocalComposer(e)
                    ? this._localTemplate(e)
                    : this._remoteTemplate(e);
                },
              },
              {
                key: "generateRequestUrl",
                value: function (e) {
                  return this.htmlPages && this.htmlPages.indexOf(e) >= 0
                    ? this.htmlPagesPath + e + ".html"
                    : this._renderComposerEndpoint(e);
                },
              },
              { key: "onPageDefinitionNotFound", value: function (e) {} },
              {
                key: "clear",
                value: function () {
                  this.storage.clear();
              ...
              },
              {
                ...
                value: function (e, t, n) {
                  ...
                  return i
                    ? (this.TemplateManager.removeTemplate(e),
                      this._getFromComposerEngine(e, t))
                    : ((r = this.storage.getItem(e)),
                      this.cache && r
                        ? Promise.resolve(r)
                        : this._getFromConnector(e, t, n));
                },
              },
              {
              ...
              },
              {
                ...
                value: function (e, t, n) {
                  ...
                  return (
                    (t = t || {}),
                    (t.url = this.generateRequestUrl(e, t, n)),
                    to.emit(i, t),
                    this.connector
                      .getJSON(t)
                      .then(function (n) {
                            ...
                            te().mark(function t(n) {
                              return te().wrap(function (t) {
                                for (;;)
                                  switch ((t.prev = t.next)) {
                                    case 0:
                                      return (t.next = 2), r._onResponseFail(e);
                                    case 2:
                                      return (
                                        (n = t.sent),
                                        console.error(n),
                                        t.abrupt("return", n.message)
                                      );
                                    case 5:
                                    case "end":
                                      return t.stop();
              ...
              },
              {
                ...
                value: function (e, t) {
                  ...
                  return (
                    (t = t || {}),
                    (t.url = this.generateRequestUrl(e)),
                    to.emit(r, t),
                    this.connector
                      .getHTML(t)
                      .then(function (r) {
                      ...
                      .catch(function (t) {
                        return (
                          n._onResponseFail(e), console.error(t), t.message
                        );
                      })
                  );
                },
              },
              {
                ...
                value: function (e, t, n) {
                  var r = Fo.PAGE_RESPONSE,
                    i = Fo.DATA_LOAD;
                  (n.page = e), to.emit(r, n);
                  var o = this.sanitizer.parse(n);
                  return this.storage.setItem(e, o), to.emit(i, o), o;
                },
              },
              {
                key: "_onResponseHTML",
                value: function (e, t, n) {
                  ...
                  return this.storage.setItem(e, a), to.emit(i, a), a;
                },
              },
              {
                key: "_onResponseFail",
                value: function (e) {
                  return (
                    this.onPageDefinitionNotFound &&
                      this.onPageDefinitionNotFound(e),
                    Promise.reject(
                      new Error(
                        "Definition file for page '".concat(e, "' not found.")
                      )
                    )
                  );
                },
        ...
        Vo = {
          ...
          next: function (e) {},
          error: function (e) {
            if (Ho.useDeprecatedSynchronousErrorHandling) throw e;
            pe(e);
          },
          complete: function () {},
        },
              ...
              if (!this.closed) {
                ...
                if (fe(o)) {
                  ...
                  try {
                    ...
                    t = e instanceof Wo ? ve(e.errors) : [e];
                  }
                }
                if (zo(a))
                ...
                if ("object" == typeof n) {
                  n instanceof t
                    ...
                    : ((o.syncErrorThrowable = !0),
                      (o.destination = new Qo(o, n)));
                  break;
                }
              default:
                (o.syncErrorThrowable = !0),
                  (o.destination = new Qo(o, n, r, i));
            }
            return o;
          }
          return (
            ...
            return (
              fe(n)
                ...
                : n &&
                  ...
                  n !== Vo &&
                    ((u = Object.create(n)),
                    fe(u.unsubscribe) && o.add(u.unsubscribe.bind(u)),
          ...
          return (
            ...
            (t.prototype.next = function (e) {
              if (!this.isStopped && this._next) {
                ...
                Ho.useDeprecatedSynchronousErrorHandling && t.syncErrorThrowable
            ...
            (t.prototype.error = function (e) {
              if (!this.isStopped) {
                var t = this._parentSubscriber,
                  n = Ho.useDeprecatedSynchronousErrorHandling;
                if (this._error)
            ...
            (t.prototype.complete = function () {
              ...
              if (!this.isStopped) {
                ...
                if (this._complete) {
                  ...
                  Ho.useDeprecatedSynchronousErrorHandling &&
            ...
            (t.prototype.__tryOrUnsub = function (e, t) {
              try {
                ...
                if (
                  (this.unsubscribe(), Ho.useDeprecatedSynchronousErrorHandling)
                )
                  throw e;
                pe(e);
              }
            ...
            (t.prototype.__tryOrSetError = function (e, t, n) {
              ...
              try {
                ...
                return Ho.useDeprecatedSynchronousErrorHandling
          ...
          return (
            ...
            (e.prototype._trySubscribe = function (e) {
              try {
                ...
                Ho.useDeprecatedSynchronousErrorHandling &&
                  ...
                  ye(e) ? e.error(t) : console.warn(t);
              }
            }),
            (e.prototype.forEach = function (e, t) {
              var n = this;
              return new (t = be(t))(function (t, r) {
                var i;
                i = n.subscribe(
                  function (t) {
                    try {
            ...
            (e.prototype.pipe = function () {
              for (var e = [], t = 0; t < arguments.length; t++)
                e[t] = arguments[t];
              return 0 === e.length ? this : me(e)(this);
            }),
            (e.prototype.toPromise = function (e) {
              var t = this;
              return new (e = be(e))(function (e, n) {
                var r;
                t.subscribe(
                  function (e) {
                    return (r = e);
        ...
        Zo = (function () {
          ...
          return (
            (e.prototype.call = function (e, t) {
              return t.subscribe(new ea(e, this.project, this.thisArg));
            }),
            e
          );
        })(),
        ...
        ta =
          ...
          (function () {
            ...
            return (
              (e.prototype.call = function (e, t) {
                return t.subscribe(new na(e, this.predicate, this.thisArg));
              }),
              e
            );
          })()),
          ...
          return (
            ...
            (t.prototype._subscribe = function (e) {
              ...
              return this.hasError
                ? (e.error(this.thrownError), Yo.EMPTY)
                : this.isStopped
                ? (e.complete(), Yo.EMPTY)
                : (this.observers.push(e), new oa(this, e));
            }),
        ...
        sa = (function (e) {
          ...
          return (
            ...
            (t.prototype._subscribe = function (e) {
              var t = this.source;
              return t ? this.source.subscribe(e) : Yo.EMPTY;
            }),
            t
          );
        })(ua),
        ...
        la = (function (e) {
          ...
          return (
            ...
            (t.prototype.recycleAsyncId = function (e, t, n) {
              return (
                void 0 === n && (n = 0),
                null !== n && this.delay === n && this.pending === !1
                  ? t
      ...
      var ba = (function () {
        ...
        wa =
          ((function () {
            ...
            return (
              (e.prototype.call = function (e, t) {
                return t.subscribe(new wa(e, this.scheduler, this.delay));
              }),
              e
            );
          })(),
              ...
              (t.prototype.scheduleMessage = function (e) {
                ...
                n.add(
                  this.scheduler.schedule(
                    t.dispatch,
                    this.delay,
                    new Ea(e, this.destination)
                  )
                );
              }),
              (t.prototype._next = function (e) {
                this.scheduleMessage(ba.createNext(e));
              }),
              (t.prototype._error = function (e) {
                this.scheduleMessage(ba.createError(e)), this.unsubscribe();
              }),
              (t.prototype._complete = function () {
                this.scheduleMessage(ba.createComplete()), this.unsubscribe();
              }),
              t
            );
          })(Jo)),
        ...
        _a = (function (e) {
          ...
          return (
            ...
            (t.prototype.nextTimeWindow = function (t) {
              this.isStopped ||
                (this._events.push(new Sa(this._getNow(), t)),
            ...
            (t.prototype._subscribe = function (e) {
              ...
              if (
                (this.isStopped || this.hasError
                  ? (t = Yo.EMPTY)
                  : (this.observers.push(e), (t = new oa(this, e))),
                i && e.add((e = new wa(e, i))),
                n)
              )
                for (var a = 0; a < o && !e.closed; a++) e.next(r[a]);
              else for (var a = 0; a < o && !e.closed; a++) e.next(r[a].value);
              return (
                this.hasError
            ...
            Be(e, [
              {
                ...
                value: function (e) {
                  return (
                    this.subscriptions.filter(function (t) {
                      return t.channel === e;
                    }).length > 0
                  );
                },
              ...
              },
              {
                ...
                value: function (e, t) {
                  t.node.intervals || (t.node.intervals = []),
                    t.node.ids || (t.node.ids = []);
                  var n = function (t) {
                    ...
                    s = function () {
                      var s = i(e),
                        ...
                        l = u(e),
                        f = o(t.node);
                      return !c || c < s || (c === s && f != l)
                        ? (r(t.node, s), a(t.node, l), t.apply(this, arguments))
                        : void r(t.node, s);
                    }.bind(this);
                  return (s.node = t.node), s;
                },
              },
              {
                key: "subscribe",
                value: function (e, t, n, r) {
                  if (!this.hasSubscription(e)) {
                    var i,
                      o = t;
                    n === !1 && (o = this.makeCallbackWithNoReplay(e, t));
                    var a = this._firstInstanceOfObserver(o.node, e);
                    a === -1
                      ? ((i = e.subscribe(o)), (a = e.observers.length - 1))
                      : (i = e.observers[a]),
                      (i.node = o.node);
                    var u = {
                      channel: e,
        ...
        Ta = (function () {
          function e(t) {
            Ve(this, e), (this.componentConnector = t);
          }
          return (
            qe(e, [
              {
              ...
              },
              {
                ...
                value: function (e) {
                  ...
                  if (
                    Polymer &&
                    Polymer.Settings &&
                    (Polymer.Settings.hasShadow === !1 ||
                      Polymer.Settings.useShadow === !1)
                  ) {
                    var n = Polymer.dom(e);
              ...
              },
              {
                ...
                value: function (e, t, n) {
                  ...
                  (r =
                    i && e.detail && e.detail.hasOwnProperty("value")
                      ? Polymer && Polymer.dom(e).rootTarget
                        ? Polymer.dom(e).rootTarget[i]
                        : e.detail.value
                      : e.detail),
              ...
              },
              {
                ...
                value: function (e, t, n) {
                  ...
                  if (t && t.constructor._finalize) {
                    ...
                    return o
                      ? void (t[i.property] = i.value)
                      : this._handleAttribute(t, i);
                  }
                  return ((t && t.getPropertyInfo) ||
                    (void 0 !== Polymer.Element &&
                      t instanceof Polymer.Element == !1)) &&
                    ((r = t.getPropertyInfo
                      ? t.getPropertyInfo(i.property)
                      : this._getTargetProperties(t)[i.property]),
                    r && r.defined && !r.readOnly && !r.computed)
                    ? t.set(i.path, i.value)
                    : ((t && void 0 === t.getPropertyInfo) ||
                        (void 0 !== Polymer.Element &&
                          t instanceof Polymer.Element == !1)) &&
                      ((r =
                        void 0 !== this._getTargetProperties(t)
                          ? this._getTargetProperties(t)[i.property]
                          : void 0),
                      r && !r.readOnly && !r.computed)
                    ? t.set(i.path, i.value)
                    : this._handleAttribute(t, i);
                },
              },
              {
                ...
                value: function (e, t) {
                  if (e && t && !e.__isCellsConnected) {
                    if (t.in)
                      for (var n in t.in)
                        t.in.hasOwnProperty(n) &&
                          this.componentConnector.manager.get(n)._events[0] &&
                          (t.ignoreAttr
                            ? t.ignoreAttr.push(t.in[n].bind)
                            : (t.ignoreAttr = [t.in[n].bind]));
                    if (t.out)
                      for (var r in t.out)
                        if (t.out.hasOwnProperty(r)) {
                          ...
                          if (2 === o) {
                            if (
                              i &&
                              e.__data &&
                              !this.componentConnector.manager.get(r)
                                ._events[0] &&
                              e &&
                              e._hasReadOnlyEffect &&
                              !e._hasReadOnlyEffect(i) &&
                              !e._hasComputedEffect(i)
                            ) {
                              var a = e[i];
                            ...
                            i &&
                            e.__data__ &&
                            !this.componentConnector.get(r)._events[0] &&
                            e &&
                            e.getPropertyInfo
                          ) {
                            var u = e.getPropertyInfo(i);
                            if (u.defined && !u.readOnly && !u.computed) {
                              var s = e[i];
                              (e.__data__[i] = void 0), (e[i] = s);
                            }
                          }
                        }
                ...
                value: function (e) {
                  ...
                  return (
                    e.constructor.config
                      ? (t = e.constructor.config.properties)
                      : e.constructor._properties &&
                        (t = e.constructor._properties),
                    t
                  );
                },
              },
              ...
              },
              {
                ...
                value: function (e, t, n) {
                  ...
                  return (
                    o && e.detail && e.detail.hasOwnProperty("value")
                      ? ((i = e.detail.value),
                        (t = t || o),
                        (r = e.detail.path ? e.detail.path.replace(o, t) : t))
                      : ((r = t), (i = e.detail)),
                    void 0 !== n &&
                      void 0 === n.is &&
                      "object" === He(i) &&
                      (Polymer && void 0 === Polymer.Element
                        ? (i = JSON.stringify(i))
                        : (Polymer && n instanceof Polymer.Element) === !1 &&
                          (i = JSON.stringify(i))),
                    { path: r, value: i, property: t }
                  );
                },
              },
            ]),
        ...
        Aa = (function () {
          function e(t) {
            var n = this;
            Je(this, e),
              (this._parseActionInEvent = function (e, t, r) {
                var i,
                  o,
                  a = n._getProperyChangedName(e.type);
                return (
                  a && e.detail && e.detail.hasOwnProperty("value")
                    ? ((i = e.detail.value),
                      (t = t || a),
                      (o = e.detail.path ? e.detail.path.replace(a, t) : t))
                    : ((o = t), (i = e.detail)),
                  { path: o, value: i, property: t }
                );
              }),
            ...
            $e(e, [
              {
                ...
                value: function (e) {
                  var t = e.tagName.includes("-"),
                    n =
                      e.updateComplete instanceof Promise &&
              ...
              },
              {
                ...
                value: function (e, t, n) {
                  ...
                  Oo.includes(n) ? To(t, n, r.value) : (t[n] = r.value);
                },
              },
              {
                key: "processFirstTimeConnections",
        ...
        Ia = (function () {
          function e(t) {
            tt(this, e), (this.componentConnector = t);
          }
          return (
            rt(e, [
              {
              ...
              },
              {
                ...
                value: function (e) {
                  var t = e.tagName.includes("-");
                  return Boolean(
                    !t || customElements.get(e.tagName.toLowerCase())
                  );
                },
              },
              {
                ...
                value: function (e, t, n) {
                  ...
                  return (
                    o && e.detail && e.detail.hasOwnProperty("value")
                      ? ((r = e.detail.value),
                        (t = t || o),
                        (i = e.detail.path ? e.detail.path.replace(o, t) : t))
                      : ((i = t), (r = e.detail)),
                    void 0 !== n &&
                      void 0 === n.is &&
                      "object" === et(r) &&
                      (r = JSON.stringify(r)),
                    { path: i, value: r, property: t }
                  );
                },
              },
            ]),
        ...
        Ma = (function () {
          function e(t) {
            ut(this, e),
              ...
              (this.adapters[Ra] = new Ta(t)),
              (this.adapters[La] = new Aa(t)),
              (this.adapters[Na] = new Ia(t));
          }
          return (
            ct(e, [
              {
        ...
        Da = "__bridge_ch_featureflag",
        Fa = "featureFlagChangedCallback",
        Ba = new Map(),
        Ua = (function () {
          function e(t) {
            Et(this, e),
              (this._featureCollection = {}),
              (this._connector = t.ComponentConnector);
          }
          return (
            St(e, [
              {
              ...
              },
              {
                ...
                value: function (e) {
                  ...
                  return i.hasOwnProperty(t) && i[t].hasOwnProperty("value")
                    ? i[t].value
                    : i.hasOwnProperty(t) && i[t].hasOwnProperty("defaultValue")
                    ? i[t].defaultValue
                    : void 0 !== r
                    ? r
                    : n;
              ...
              },
              {
                key: "extend",
                value: function (e) {
                  return wt(this._featureCollection, e), this._publish();
                },
              },
              {
                key: "register",
                value: function (e) {
                  ...
                  return (
                    Object.entries(e)
                      ...
                      .forEach(function (e) {
                        return wt(t._featureCollection, e);
                      }),
                    this._publish()
                  );
                },
              ...
              },
              {
                ...
                value: function (e) {
                  ...
                  return (
                    "function" == typeof e &&
                      this._connector.manager.get(Da).subscribe(function () {
                        return e(t);
                      }),
                    this
                  );
              ...
              },
              {
                key: "_publish",
                value: function () {
                  var e = this._connector.manager.get(Da);
                  return (
                    e.next(new CustomEvent(Da, { detail: this.collection })),
                    this
                  );
                },
              },
              ...
              },
              {
                ...
                value: function () {
                  for (var e in this.channels)
                    this.channels.hasOwnProperty(e) && this.channels[e].clean();
                },
              },
              {
                ...
                value: function () {
                  for (var e in this.channels)
                    this.channels.hasOwnProperty(e) && delete this.channels[e];
                },
              },
              {
                key: "has",
        ...
        Ha = wo.externalEventsCodes,
        Va = (function () {
          function e(t) {
            Ut(this, e),
              (this.adapterResolver = new Ma(this)),
              (this.manager = new Ga()),
            ...
            Ht(e, [
              {
                ...
                value: function (e) {
                  ...
                  return t || ((t = new Pa(e)), this.subscriptors.set(e, t)), t;
                },
              },
              {
                ...
                value: function (e) {
                  ...
                  t &&
                    n &&
                    (this._registerOutConnections(t, n.out),
                    this._registerInConnections(t, n.in)),
                    r.processFirstTimeConnections(t, n);
                },
              },
              {
                ...
                value: function (e, t) {
                  e &&
                    t &&
                    (this._registerOutConnections(e, t.out),
                    this._updateInConnections(e, t.in));
                },
              },
              {
              ...
              },
              {
                ...
                value: function (e, t, n) {
                  ...
                  if (
                    this.isActiveBridgeChannel(e) ||
                    (!this.isActiveBridgeChannel(e) &&
                      !this.hasSubscriptions(i, e))
                  ) {
                  ...
                  return function (i) {
                    var o = n.adapterResolver.getNodeAdapter(e),
                      a = function n(a, u) {
                        o.isUnresolved(e)
                          ? r(n)
                          : ("function" == typeof t || "function" == typeof e[t]
                              ? o.dispatchActionFunction(i, e, t)
                              : o.dispatchActionProperty(i, e, t),
                            u && u.disconnect());
                      };
                    if (o.isUnresolved(e)) {
                      var u = new MutationObserver(a),
                        s = {
                          attributes: !1,
                          childList: !0,
                          characterData: !0,
                        };
                      u.observe(e, s), r(a, 100);
                    } else a();
                  };
                },
              },
              {
                ...
                value: function (e, t, n, r) {
                  ...
                  return Boolean(
                    (i._subscriptions || []).find(function (e) {
                      return (
                        e.node === t && e.channelName === n && e.eventName === r
                      );
                    })
                  );
                },
              ...
              },
              {
                key: "addPublication",
                value: function (e, t, n, r) {
                  if (this.isBridgeChannel(e))
                    console.warn(
                      "Forbidden operation. You are trying to write to a private channel (".concat(
                        e,
                        ")."
                      )
                    );
                ...
                value: function (e, t) {
                  if (this.isBridgeChannel(e))
                    ...
                    var n = this.manager.get(e),
                      r = "".concat(e, "-publish");
                    n.next(new CustomEvent(r, { detail: t }));
                  }
                },
              },
              {
              ...
              },
              {
                ...
                value: function (e, t, n, r) {
                  var i = this,
                    o = Ha.AFTER_PUBLISH,
                    a = Ha.NAV_REQUEST,
                    u = Ha.ROUTER_BACKSTEP,
                    s = Ha.TRACK_EVENT,
                    c = Ha.LOG_EVENT,
                    l = function (e) {
                      return i.bridge.featureFlagCollection.value(
                        Rt({ defaultValue: !0 }, e)
                      );
                    },
                    f = Ee(e, t);
                  ...
                  var p = f.subscribe(function (t) {
                    var f = i.adapterResolver.getNodeAdapter(e);
                    if (f.isEventAtTarget(t)) {
                      if (
                        (n.next(t),
                        to.emit(o, t),
                        r && r.link && l(r.link.featureFlag))
                      ) {
                        var p = Rt({}, r.link);
                        r.link.page &&
                          r.link.page.hasOwnProperty("bind") &&
                          (p.page = t.detail[r.link.page.bind]),
                          r.link.cleanUntil &&
                            r.link.cleanUntil.hasOwnProperty("bind") &&
                            (p.cleanUntil = t.detail[r.link.cleanUntil.bind]),
                          to.emit(a, { event: t, detail: p });
                      }
                      r &&
                        r.backStep &&
                        l(r.backStep.featureFlag) &&
                        to.emit(u, { event: t, detail: {} }),
                        r &&
                          r.analytics &&
                          l(r.analytics.featureFlag) &&
                          to.emit(s, { event: t, detail: r.analytics }),
                        r &&
                          r.log &&
                          l(r.log.featureFlag) &&
                          to.emit(c, { event: t, detail: r.log }),
              ...
              },
              {
                ...
                value: function (e, t) {
                  return Boolean(
                    e.subscriptions.find(function (e) {
        ...
        za = (function () {
          function e(t, n) {
            ...
            Wt(this, e),
              ...
              (this.isWildcarded = !1),
              (this.name = t),
              (this.patterns = "string" == typeof n ? [n] : n),
              (this.regexps = this.patterns.map(function (e) {
                return r._getRegExp(e);
              }));
          }
          return (
            Kt(e, [
              ...
              },
              {
                ...
                value: function t(n) {
                  (n = n || {}), (this.params = {});
                  for (
                    var r, t = this.patterns[0];
                    null !== (r = e.PARAM.exec(this.patterns[0]));

                  )
                    (t = t.replace(r[0], n[r[1]])),
                      (this.params[r[1]] = n[r[1]]);
                  var i = [];
                  for (var o in n)
                    this.params.hasOwnProperty(o) ||
                      i.push(o + "=" + encodeURIComponent(n[o]));
              ...
              },
              {
                ...
                value: function (e) {
                  var t = this,
                    n = null;
                  return (
                    this.regexps.forEach(function (r, i) {
                      var o = e.match(r);
                      o &&
                        (n = {
                          index: i,
                          regex: t.regexps[i],
                          pattern: t.patterns[i],
                          parts: o,
                        });
                    }),
                    n
              ...
              },
              {
                ...
                value: function (t) {
                  ...
                  if (((this.params = {}), (this.subroute = void 0), n)) {
                    var r,
                      i = 1;
                    for (
                      n.parts[0] !== n.parts.input &&
                      (this.subroute = n.parts.input.substring(
                        n.parts[0].length - 1
                      ));
                      null !== (r = e.PARAM.exec(n.pattern));

                    )
                      (this.params[r[1]] = this._parseParam(n.parts[i])), i++;
                  }
                },
              },
              {
                ...
                value: function (e) {
                  ...
                  for (var t in this.query)
                    this.query.hasOwnProperty(t) &&
                      (this.params[t] = this.query[t]);
                },
              },
              {
                key: "is404",
      ...
      var qa,
        ...
        eu = function (e) {
          if (e && "function" == typeof e[$o]) return Xa(e);
          if (Za(e)) return ma(e);
          if (Xt(e)) return Ja(e);
          if (e && "function" == typeof e[Qa]) return $a(e);
          var t = he(e) ? "an invalid object" : "'" + e + "'",
            n =
              "You provided " +
              t +
        ...
        ru =
          ...
          (function () {
            ...
            return (
              (e.prototype.call = function (e, t) {
                return t.subscribe(new iu(e, this.project, this.concurrent));
              }),
              e
            );
          })()),
        ...
        ou = (function () {
          ...
          return (
            (e.prototype.call = function (e, t) {
              return t.subscribe(new au(e, this.compare, this.keySelector));
            }),
            e
          );
        })(),
        ...
        uu = (function () {
          function e() {
            dn(this, e), (this.navStack = []), (this.skipNav = {});
          }
          return (
            mn(e, [
              {
              ...
              },
              {
                ...
                value: function (e) {
                  (e.skipHistory !== !0 && e.skipHistory !== !1) ||
                    (this.skipNav["".concat(e.from, ":").concat(e.to)] =
                      e.skipHistory);
                },
              },
              {
              ...
              },
              {
                ...
                value: function (e) {
                  return (
                    this.skipNav["".concat(e.from, ":").concat(e.to)] === !0
                  );
                },
              },
              {
                ...
                value: function (e) {
                  var t =
                    arguments.length > 1 && void 0 !== arguments[1]
                      ? arguments[1]
                      : {};
                  return { page: e, params: t };
                },
              },
              {
                key: "createNavigation",
                value: function (e, t) {
                  return { from: e ? e.page : void 0, to: t ? t.page : void 0 };
                },
              },
              {
                key: "push",
                ...
                value: function (e) {
                  ...
                  (this.top() &&
                    (null === (t = this.top()) || void 0 === t
                      ? void 0
                      : t.page) === e.page) ||
                    (this.navStack[this.navStack.length - 1] = e);
                },
              },
              {
                key: "pop",
              ...
              },
              {
                ...
                value: function (e, t) {
                  ...
                  if (this.isBackwardNavigation(n)) {
                    for (
                      ;
                      this.isSkipNavigation(
                        this._reverseNavigation(this.lastNavigation())
                      );
              ...
              },
              {
                ...
                value: function (e) {
                  if (
                    this.navStack.find(function (t) {
                      return t.page === e;
                    })
                  ) {
                    var t = null;
                    do t = this.navStack.pop();
                    while (t && t.page != e);
                  }
                },
              },
        ...
        hu = (function (e) {
          function t() {
            var e;
            return (
              In(this, t), (e = n.call(this)), (e._currentSubscription = su), e
            );
          }
          Bn(t, e);
          var n = Gn(t);
            ...
            Ln(t, [
              {
                ...
                value: function (e) {
                  this.closed ||
                    ("function" == typeof e && (e = new Yo(e)),
                    this._currentSubscription &&
                      (this.remove(this._currentSubscription),
                      this._currentSubscription.unsubscribe(),
                      (this._currentSubscription = null)),
                    Dn(qn(t.prototype), "add", this).call(
                      this,
                      (this._currentSubscription = e)
                    ));
                },
              },
            ]),
        ...
        vu = (function () {
          function e() {
            var t = this;
            In(this, e), (this.interceptorContext = {});
            var n = cu.TEMPLATE_TRANSITION_END;
            return (
              lu || (lu = this),
          ...
          return (
            Ln(e, [
              ...
              { key: "handler", value: function (e) {} },
              {
                key: "addRoute",
                value: function (e, t) {
                  return (this.routes[e] = new za(e, t)), this.routes[e];
                },
              },
              {
                key: "addRoutes",
                value: function (e) {
                  var t = {};
                  for (var n in e)
                    e.hasOwnProperty(n) && (t[n] = this.addRoute(n, e[n]));
                  return t;
                },
              },
              {
                ...
                value: function (e) {
                  for (var t = 0; t < e.length; t++)
                    this.navigationStack.addSkipNavigation(e[t]);
                },
              },
              {
                key: "_getHashPath",
              ...
              },
              {
                ...
                value: function () {
                  return Ee(window, "hashchange").pipe(
                    we(this._getHashPath),
                    hn(this._getHashPath())
                  );
                },
              },
              {
              ...
              },
              {
                ...
                value: function () {
                  return ln(
                    Ee(window, "popstate"),
                    Ee(window, "pushstate")
                  ).pipe(we(this._getURLPath), hn(this._getURLPath()));
                },
              },
              {
                key: "matchRoute",
                value: function (e) {
                  ...
                  for (var a in this.routes)
                    if (
                      this.routes.hasOwnProperty(a) &&
                      ((t = this.routes[a]),
                      (!t.is404() || t.isAccessible) && t.matchPath(i))
                    )
                      return (
                        t.isWildcarded
                          ? t.parsePath(e)
                          : (t.parsePath(i), t.parseQuery(o)),
                        t
                      );
                },
              },
                  ...
                  if (e) {
                    ...
                    if (n) {
                      ...
                      for (o = 0; o < a; o++) {
                        var u = n[o].split("="),
                          s = Pn(u, 2);
                        (r = s[0]), (i = s[1]), (t[r] = decodeURIComponent(i));
                      }
                    }
                  }
                  return t;
              ...
              },
              {
                key: "_setup404",
                value: function () {
                  var e = this.routes[za._404_PAGE_NAME];
                  if (e && 1 === e.patterns.length) {
                    var t = this.getRouteWithPattern(e.patterns[0]);
                    (e.redirectPage = t ? t.name : e.name),
                      (e.isAccessible = !t);
                  }
                  return e;
                },
              },
              {
                ...
                value: function (e) {
                  for (var t in this.routes)
                    if (this.routes.hasOwnProperty(t)) {
                      var n = this.routes[t];
                      if (!n.is404() && n.patterns.includes(e)) return n;
                    }
                  return null;
                },
              },
              ...
              },
              {
                ...
                value: function (e, t) {
                  var n = {
                    from: { page: e.page, params: e.params },
                    to: { page: t.name, path: t.patterns[0], params: t.params },
                  };
                  return Cn(
                    Cn({}, this.interceptor(n, this.interceptorContext)),
                    n
                  );
                },
              },
              {
                ...
                value: function (e) {
                  this.interceptorContext = _n({}, this.interceptorContext, e);
                },
              },
              {
                key: "setInterceptorContext",
                value: function (e) {
                  this.interceptorContext = _n({}, e);
                },
              },
              {
                key: "getInterceptorContext",
                value: function () {
                  return _n({}, this.interceptorContext);
                },
              },
              {
                key: "start",
                value: function () {
                  ...
                  if (!qa) {
                    var t = new hu();
                    Ya = this._setup404();
                    var n = this.useHistory
                        ? this._observeStateChange()
                        : this._observeHashChange(),
                      r = n.pipe(
                        vn(),
                        we(this.matchRoute.bind(this)),
                        Pe(function (t) {
                          return (
                            !t ||
                            t.name !== e.cancelledNavigation ||
                            ((e.cancelledNavigation = void 0),
                            (e.isNavigationInProgress = !1),
                            e.currentRoute.name !==
                              e.navigationStack.top().page &&
                              e.navigationStack.push({
                                page: e.currentRoute.name,
                    ...
                    r.forEach(function (n) {
                      if (e.hashIsDirty) e.hashIsDirty = !1;
                      else if (n) {
                        ...
                        if (u.intercept)
                          return (
                            ...
                            u.redirect
                              ...
                              : (e.go(r, i, !1), (e.cancelledNavigation = r)),
                            void (
                              e.channelManager &&
                              setTimeout(function () {
                                return e.channelManager.publishInterceptedNavigation(
                                  u
                                );
                              }, 0)
                            )
                          );
                        var s = e.navigationStack.update(o, a).page;
                        if (s !== a.page) return void e.go(s, void 0, !1);
                        Wa = n;
                        var c = new Yo(function () {
                          return e.currentRoute;
                        });
                        t.add(c),
                          e.currentRoute.handler(),
                          e.handler(e.currentRoute);
                      } else
                        Ya && Ya.redirectPage && e.goReplacing(Ya.redirectPage);
                    }),
                      (qa = new Yo(r, t));
                  }
                  return qa;
              ...
              },
              {
                key: "stop",
                value: function () {
                  qa && (qa.unsubscribe(), (qa = null)),
                    (this.isNavigationInProgress = !1),
                    (this.hashIsDirty = !1);
                },
              },
              {
                ...
                value: function (t, n, r, i) {
                  if (!this.isNavigationInProgress) {
                    if (void 0 !== i) {
                      ...
                      (a.skipHistory = i),
                        this.navigationStack.addSkipNavigation(a);
                    }
                    var u = t.replace(e.LTRIM_SLASH, ""),
                      s = this.getPath(u, n);
                    s !== this._getHashPath() &&
                      ((this.isNavigationInProgress = !0),
                      this.updatePathInBrowser(s, r));
                  }
                },
              },
              {
                ...
                value: function () {
                  ...
                  if (this.navigationStack.length > 1) {
                    for (
                      var t = this.navigationStack.pop(),
                        n = t,
                        r = this.getLastRoute();
                      this.navigationStack.isSkipNavigation({
                        from: n.page,
                        to: r.page,
                      }) && this.navigationStack.length > 1;

                    )
                      (n = this.navigationStack.pop()),
                    ...
                    (e.from = this.getLastRoute()),
                      (e.to = this.getLastRoute());
                  return e;
                },
              },
              {
                ...
                value: function (e, t) {
                  this.useHistory
                    ? t
                      ? this.historyReplaceState(e)
                      : this.historyPushState(e)
                    : t
                    ? this.locationReplace(e)
                    : this.locationHash(e);
                },
              },
              {
                key: "updateSubrouteInBrowser",
                value: function (e) {
                  var t = this.currentRoute,
                    n = this.getPath(t.name, t.params);
                  e &&
                    (n.endsWith("/") && (n = n.substring(0, n.length - 1)),
                    (n += e)),
                    this.updatePathInBrowser(n, !0),
                    (this.hashIsDirty = !0);
                },
              },
              {
      ...
      (vu.SUPPORTS_HISTORY_API =
        ...
        (vu.HASH_PREFIX = /^#!?\/*/),
        (vu.PATH_PREFIX = /^\/*/),
        (vu.isNavigationInProgress = !1),
        (vu.hashIsDirty = !1);
      var yu = wo.externalEventsCodes,
        du = function (e, t) {
          return function () {
            if (--e < 1) return t();
          };
            ...
            Jn(e, [
                ...
                value: function (e, t, n) {
                  ...
                  return new Promise(function (a) {
                    var u = function () {
                      ...
                      s = e;
                    if ((Array.isArray(s) || (s = [e]), 0 === s.length))
                      return void u();
                    to.emit(i);
                    for (
                      var c = du(s.length, function () {
                          to.emit(o), u();
                        }),
                        l = 0;
                      l < s.length;
                      ...
                      var f = s[l];
                      r._importElement(t, f.spec.path, c);
                    }
                  });
                },
              },
              {
                ...
                value: function (e, t, n) {
                  var r = this,
                    ...
                    o = yu.AFTER_IMPORT,
                    a = e;
                  if ((Array.isArray(a) || (a = [e]), 0 === a.length))
                    return void (n && n.call(this));
                  var u = this._createPriorityLists(a);
                  to.emit(i),
                    this._chainElementLoading(t, u, 0).then(function () {
                      to.emit(o), n && n.call(r);
                    });
                },
              },
              {
              ...
              },
              {
                ...
                value: function (e) {
                  for (
                    var t =
                        this._createSortedArratByPriorityAndUniqueElements(e),
                      n = t[0].priority,
                      r = [[]],
                      i = 0,
                      o = 0;
              ...
              },
              {
                ...
                value: function (e, t, n) {
                  ...
                  for (var o = 0; o < t[n].length; o++)
                    i.push(this._importElementPromise(e, t[n][o].spec.path));
                  var a = n + 1;
        ...
        bu = (function (e) {
          function t(e) {
            ...
            return (
              ...
              (r = n.call(this)),
              (r.spec = e),
              (r.spec.node = r.spec.node
                ? r.spec.node
                : r.createElement(r.spec.tagName)),
              r
            );
          }
          ar(t, e);
            ...
            tr(t, [
              {
                ...
                value: function () {
                  var e = this.spec;
                  if (e.connections && e.connections.ignoreAttr)
                    for (var n = 0; n < e.connections.ignoreAttr.length; n++) {
                      var r = e.connections.ignoreAttr[n];
                      delete e.properties[r];
                    }
                  ir(pr(t.prototype), "setProps", this).call(
                    this,
                    this.node,
                    e.properties,
                    e.render
              ...
              },
              {
                key: "setAttrs",
                value: function () {
                  ir(pr(t.prototype), "setAttrs", this).call(
                    this,
                    this.node,
          ...
          return (
            dr(t, [
                    ...
                    throw new Error(
                      ""
                        .concat(
                          ...
                          " has no valid template. Template was "
                        )
                        .concat(n)
                    );
                  }
              ...
              },
              {
                key: "_getAttribute",
                value: function (e) {
                  var t = this._getTemplate(this.node),
                    n = "";
                  try {
                    n = t.getAttribute(e);
                  } catch (e) {
              ...
              },
              {
                ...
                value: function (e) {
                  ...
                  return n ? this._getCellsTemplateFromPage(e) : e;
                },
              },
              {
                ...
                value: function (e) {
                  var t =
                    e.shadowRoot && e.shadowRoot.childNodes
                      ? e.shadowRoot.childNodes
                      : e.children;
                  return Array.from(t).find(function (e) {
                    return (
                      e &&
                      e.tagName &&
                      (e.tagName.toLowerCase().indexOf("cells-template") !==
                        -1 ||
                        "template" === e.getAttribute("data-cells-type"))
                    );
                  });
                },
              },
              ...
              },
              {
                ...
                value: function (e) {
                  if (e) {
                    ...
                    (this.fixedChildren = this.fixedChildren.concat(n)),
                    ...
                    for (var r = [], i = 0; i < t.length; i++) {
                      var o = t[i],
                        ...
                        u = a.container,
                        s = a.slot;
                      o.node.setAttribute("data-select", s),
                        o.node.setAttribute("slot", s),
                        "object" !== hr(r[u]) && (r[u] = this.getZone(u)),
                        r[u].appendChild(o.node);
                    }
                  }
                },
              },
        ...
        Su = (function () {
          function e() {
            ...
            (this.viewLimit =
              t.viewLimit && t.viewLimit >= 1 ? t.viewLimit : 3),
              (this.fixedTemplates = this.fixedTemplates.concat(n)),
            ...
            xr(e, [
              {
                ...
                value: function (e, t) {
                  ...
                  return (
                    r ||
                      ((r = this._createCellsTemplate(e, t)),
                      this._storeTemplate(e, r, n)),
                    r
                  );
                },
              },
              ...
              },
              {
                ...
                value: function (e) {
                  return {
                    name: e,
                    template: { id: this.computeTemplateId(e), name: e },
                  };
                },
              },
              {
                ...
                value: function (e, t, n) {
                  ...
                  if (this.size >= this.maxSize) {
                    ...
                    a
                      ...
                      : console.warn(
                          "No space left in template cache for template ",
                          e
                        );
                  }
              ...
              },
              {
                ...
                value: function () {
                  for (
                    var e, t = !1, n = 0;
                    !t && n < this.locations.length;
                    n++
                  ) {
                    var r =
                      this.fixedTemplates.indexOf(this.locations[n]) == -1;
                ...
                value: function (e) {
                  ...
                  (this.selected = e),
                    ...
                    n &&
                      r !== u &&
                      r !== s &&
                      n.updateBridgeChannels(t, e, i, o),
                    to.emit(a, c);
                },
              },
              {
              ...
              },
              {
                key: "removeTemplates",
                value: function (e, t) {
                  for (var n in this.templates)
                    this.templates.hasOwnProperty(n) &&
                      n !== e &&
                      n !== t &&
        ...
        Tu = (function () {
          function e(e) {
            if (((this.total = e), this.total < 0)) throw new Ou();
          }
          return (
            (e.prototype.call = function (e, t) {
              return t.subscribe(new xu(e, this.total));
            }),
            e
          );
        })(),
        ...
        Au = (function () {
          ...
          return (
            (e.prototype.call = function (e, t) {
              return t.subscribe(new ju(e, this.defaultValue));
            }),
            e
          );
        })(),
        ...
        Iu = (function () {
          ...
          return (
            (e.prototype.call = function (e, t) {
              return t.subscribe(new Ru(e, this.errorFactory));
            }),
            e
          );
        })(),
        ...
        Lu = (function () {
          function e(t) {
            Fr(this, e),
              (this.componentConnector = t.ComponentConnector),
          ...
          return (
            Ur(e, [
              ...
              },
              {
                ...
                value: function (e) {
                  return this.componentConnector.manager.get(
                    this.getBridgeChannelPrefix() + e
                  );
                },
              },
              {
              ...
              },
              {
                ...
                value: function () {
                  return this.componentConnector.manager.get(
                    this.getCancelledBackNavigationChannelName()
                  );
                },
              },
              {
                ...
                value: function () {
                  return this.componentConnector.manager.get(
                    this.getInterceptedNavigationChannelName()
                  );
                },
              },
              {
              ...
              },
              {
                ...
                value: function (e, t) {
                  this.publishPrivatePageStatus(t, !0),
                    e && this.publishPrivatePageStatus(e, !1);
                },
              },
              {
              ...
              },
              {
                ...
                value: function (e, t, n, r) {
                  var i = this.componentConnector.createEvent("app-context", {
                    currentPage: t,
                    fromPage: e,
                    interceptorContext: n,
                    currentRoute: r,
                  });
                  this.getAppContextChannel().next(i);
                },
              },
              {
                key: "updateBridgeChannels",
                value: function (e, t, n, r) {
                  this.updateAppContext(e, t, n, r),
                    this.initPrivateChannel(e, t);
                },
              },
              {
                key: "publishCancelledBackNavigation",
                value: function (e) {
                  var t = this.componentConnector.createEvent(
                    "back-nav-cancelled",
                    e
                  );
              ...
              },
              {
                ...
                value: function (e) {
                  ...
                  this.getInterceptedNavigationChannel().next(t);
                },
              },
              {
              ...
              },
              {
                ...
                value: function (e, t) {
                  ...
                  r.forEach(function (e) {
                    ...
                    this.componentConnector.unregisterComponent(e, t),
                    this.componentConnector.unregisterAllSubscriptors(t),
              ...
              },
              {
                ...
                value: function (e, t) {
                  var n = Array.from(
                      this.componentConnector.subscriptors.values()
                    ).filter(function (n) {
                      var r, i;
                      return (
                        (null === (r = n.node.parentNode) || void 0 === r
                          ? void 0
                          : r.id) === e ||
                        (null === (i = n.node.parentNode) || void 0 === i
                          ? void 0
                          : i.id) === t ||
                        n.node.id === t
                      );
                    ...
                    r = n
                      .map(function (e) {
                        var t;
                        return null === (t = e.publications._subscriptions) ||
                          void 0 === t
                          ? void 0
                          : t.map(function (t) {
                              return {
                    ...
                    i = n
                      .map(function (e) {
                        var t;
                        return null === (t = e.subscriptions) || void 0 === t
                          ? void 0
                          : t.map(function (t) {
                              return {
                  ...
                  return { inConnections: i, outConnections: r };
                },
              },
              {
        ...
        Nu = wo.externalEventsCodes,
        Mu = (function () {
          function e(t) {
            zr(this, e),
              (this.bridge = t),
              (this.PageManager = t.PageManager),
              (this.ChannelManager = t.BridgeChannelManager),
              (this.TemplateManager = t.TemplateManager);
          }
          return (
            Wr(e, [
              {
                ...
                value: function () {
                  ...
                  this.ChannelManager.getBridgeChannel("config").subscribe(
                    ...
                    this.ChannelManager.getBridgeChannel(
                      "interceptor_context"
                    ).subscribe(function (t) {
                      return e._appContextSubscriptor(t);
                    });
                },
              },
              {
                key: "updateProperty",
                value: function (e, t) {
                  this.isAllowedProperty(e) &&
                    ((this.bridge[e] = t),
                    window.AppConfig && (window.AppConfig[e] = t));
                },
              },
              {
              ...
              },
              {
                ...
                value: function (e) {
                  var t = this,
                    n = Nu.TEMPLATE_REGISTERED,
                    r = this.TemplateManager.selected;
                  if (e.detail) {
                    for (var i in e.detail)
                      e.detail.hasOwnProperty(i) &&
                        this.updateProperty(i, e.detail[i]);
                    (e.detail.app || e.detail.pagesPath) &&
                      (this.PageManager.clear(),
                      this.TemplateManager.removeTemplates(
                        r,
                        this.bridge.crossContainerId
                      ),
                      to.once(n, function () {
              ...
              },
              {
                ...
                value: function (e) {
                  window.I18nMsg &&
                    e.detail &&
                    e.detail.lang &&
                    (window.I18nMsg.lang = e.detail.lang);
                },
              },
              {
              ...
              },
              {
                ...
                value: function (e) {
                  var t = e.detail;
                  this.bridge.setInterceptorContext(t);
                },
              },
            ]),
            e
          ...
          return (
            Xr(e, [
                  ...
                  var e = this,
                    t =
                      arguments.length > 0 && void 0 !== arguments[0]
                        ? arguments[0]
                        : {};
                  (this.initialParams = t),
                    this.addParams(this.initialParams),
                    this.componentConnector
                      .get(this.getComposerEngineChannelName())
                      .subscribe(function (t) {
              ...
              },
              {
                key: "addParams",
                value: function (e) {
                  this.addSegments(e.segments),
                    this.addCustomGroups(e.customGroups);
                },
              },
              {
                key: "addSegments",
              ...
              },
              {
                ...
                value: function () {
                  ...
                  t.forEach(function (t) {
                    ...
                    n
                      ? n.isConstant || (n.value = t.value)
                      : e.customGroups.push(t);
                  }),
                    (this.normalizedCustomGroups = this.normalizeCustomGroups(
                      this.customGroups
                    ));
                },
              },
              {
                ...
                value: function (e) {
                  var t = this;
                  return e.map(function (e) {
                    return t.composerEngine.customGroup(
                      e.name,
        ...
        Hu = Gu.a.get,
        Vu = Gu.a.set,
        zu = wo.monitoring.SEMAAS,
        qu = zu.mrId,
        Wu = zu.nameSpace,
        Yu = zu.identifier,
        Ku = zu.consumerId,
        Ju = zu.policy,
        Qu = (zu.tsecStorageKey, wo.externalEventsCodes),
        $u = Qu.PAGE_READY,
        Xu = Qu.PARSE_ROUTE,
        Zu = Qu.AFTER_PUBLISH,
        es = Qu.NAV_REQUEST,
        ts = Qu.BEFORE_SET_ATTR_TO_NODE,
        ns = Qu.AFTER_SET_ATTR_TO_NODE,
        rs = Qu.BEFORE_CREATE_NODE,
        is = Qu.AFTER_CREATE_NODE,
        os = Qu.BEFORE_IMPORT,
        as = Qu.AFTER_IMPORT,
        us = Qu.PAGE_REQUEST,
        ss = Qu.PAGE_RESPONSE,
        cs = Qu.DATA_LOAD,
        ls = Qu.TEMPLATE_TRANSITION_END,
        fs = Qu.TRACK_EVENT,
        ps = Qu.TEMPLATE_REGISTERED,
        hs = Qu.ROUTER_BACKSTEP,
        vs = Qu.LOG_EVENT,
        ys = (function () {
          function e(t) {
            ai(this, e), (this.bridge = null), (this.application = null);
            var n = t.semaas,
              r = void 0 === n ? {} : n,
              i = t.logs;
            if (i) {
              ...
              if (((this.application = this.initilizeSEMaaSAdapter(a)), o)) {
                var u = this.getBridgeConfiguration(r);
                this.bridge = this.initilizeSEMaaSAdapter(u);
              }
            }
          }
          return (
            si(e, [
              ...
              },
              {
                ...
                value: function (e, t) {
                  var n = t.detail,
                    r = { message: "cells-bridge::".concat(e), properties: {} },
                    i = ni({}, n, r);
                  switch (e) {
                    case $u:
                      var o = t.page,
                        a = t.components;
                      i.properties = { page: o, components: a };
                      break;
                    case Xu:
                      var u = t.name,
                        s = t.params,
                        c = t.pattern;
                      i.properties = { route: u, params: s, pattern: c };
                      break;
                    case es:
                      var l = t.event,
                        f = t.detail,
                        p = f.page,
                        h = l.detail;
                      i.properties = { page: p, params: h };
                      break;
                    case us:
                      var v = t.params,
                        y = t.url;
                      i.properties = { params: v, url: y };
                      break;
                    case ss:
                      i.properties = ni({}, t);
                      break;
                    case vs:
                      var d = t.detail,
                        ...
                        w = g.detail;
                      (i.message = m),
                        (i.properties = this.unflattenData(b, w));
                      break;
                    case Zu:
                    case ts:
                    case ns:
        ...
        ds = { extend: gi, defaultChangedCallback: di, BRIDGE_CHANNEL_KEY: Da },
        gs = bi,
        ms = (function () {
          function e(t) {
            _i(this, e),
              t.postMessageTargetOrigin
                ? "*" === t.postMessageTargetOrigin
                  ? ((this.enabled = !1),
                    console.warn(
                  ...
                  : ((this.enabled = !0),
                    (this.postMessageTargetOrigin = t.postMessageTargetOrigin))
                : (this.enabled = !1),
              (this.componentConnector = t.ComponentConnector),
              (this.bridgeChannelManager = t.BridgeChannelManager);
          }
          return (
            Ci(e, [
              {
                ...
                value: function () {
                  ...
                  this.enabled &&
                    (window.addEventListener("message", function (t) {
                      var n = t.data;
                      if (n.event) {
                        var r = e.bridgeChannelManager.getPostMessageChannel(
                            n.event
                          ),
                          i = e.componentConnector.createEvent(
                            n.event,
                            n.detail
                          );
                        r.next(i);
                ...
                value: function (e) {
                  window.parent &&
                    window.parent.postMessage(
                      { eventName: e.event, eventDetail: e.detail },
            ...
            Ai(e, [
              {
                ...
                value: function () {
                  return new Lo({ prefix: ws, persistent: !1 });
                },
              },
              {
                key: "saveAppConfig",
                value: function (e) {
                  ...
                  for (var n in e)
                    e.hasOwnProperty(n) &&
                      this.ActionChannelManager.isAllowedProperty(n) &&
                      (t[n] = e[n]);
                  Object.keys(t).length > 0 && this.storage.setItem(Es, t);
                },
              },
              {
                key: "loadAppConfig",
                value: function () {
                  var e = this.storage.getItem(Es);
                  for (var t in e)
                    e.hasOwnProperty(t) &&
                      this.ActionChannelManager.updateProperty(t, e[t]);
                },
              },
            ]),
            e
            ...
            Mi(e, [
              {
                ...
                value: function () {
                  return new Lo({ prefix: Cs, persistent: !1 });
                },
              },
              {
                key: "saveAppState",
                value: function (e, t) {
                  var n = this.storage.getItem(ks) || {};
                  (n[e] = t), this.storage.setItem(ks, n);
                },
              },
              {
                key: "loadAppState",
                value: function () {
                  var e = this.storage.getItem(ks);
        ...
        js = wo.bindingCodes,
        Is = wo.binding,
        Rs = wo.componentsPath,
        Ls = wo.composerEndpoint,
        Ns = wo.externalEvents,
        Ms = wo.externalEventsCodes,
        Ds = wo.initialTemplate,
        Fs = wo.pagesPath,
        Bs = wo.prplCodes,
        Us = wo.prpl,
        Gs = wo.preRenderState,
        Hs = wo.renderEngines,
        Vs = wo.pageTypes,
        zs = Is.DEFAULT,
        qs = Us.DEFAULT,
        ...
        Ks = (function () {
          function e(t) {
            ...
            zi(this, e),
              ...
              (this.version = "3.20.1"),
              (this.viewLimit = 1e3),
              (this.initialTemplate = Ds),
              (this.__mainNodeElement = null),
              (this.externalEvents = Ns),
              (this.pages = []),
              (this.pagesPath = Fs),
              (this.remoteTemplates = []),
              (this.useComposerEngine = !1),
              (this.appJson = ""),
              (this.appId = ""),
              (this.composerEndpoint = Ls),
              (this.templatesPath = ""),
              (this.monitoring = null),
              (this.logs = !1),
              (this.navRequestListener = null);
            var r = Ms.NAV_REQUEST,
              i = Ms.ROUTER_BACKSTEP;
            (t && "object" === Vi(t)) || (t = {}),
              (t.prplLevel = this._normalizePrplLevel(t.prplLevel)),
              (this.preRenderingPages = {});
            var o = t.dependencies;
            delete t.dependencies,
              Hi(this, t),
              this._initDependencies(o),
              "global" === this.channel &&
                (this.ComponentConnector.manager.channels = Ys),
              this.useComposerEngine && this._initComposerEngine(),
              this.mainNode
                ? this._plugExternalEvents()
                : console.warn("You should indicate the main node of your app"),
              t.featureFlag &&
                (t.featureFlag.subscribe &&
                  this.featureFlagCollection.subscribe(t.featureFlag.subscribe),
                t.featureFlag.defaultChangedCallback &&
                  ds.defaultChangedCallback(
                    t.featureFlag.defaultChangedCallback
                  ),
                t.featureFlag.defaultFeatures &&
                  this.featureFlagCollection.update({
                    features: t.featureFlag.defaultFeatures,
                  }),
                t.featureFlag.src &&
                  fetch(t.featureFlag.src)
                    .then(function (e) {
                      return e.json();
                    })
                    .then(function (e) {
              ...
              this.cache && (this.PageManager.persistent = !0),
              this.generateRequestUrl &&
                (console.assert(
                  "function" == typeof this.generateRequestUrl,
                  "generateRequestUrl has to be a function"
                ),
                (this.PageManager.generateRequestUrl =
                  this.generateRequestUrl)),
              this.onPageDefinitionNotFound &&
                (console.assert(
                  "function" == typeof this.onPageDefinitionNotFound,
                  "onPageDefinitionNotFound has to be a function"
                ),
                (this.PageManager.onPageDefinitionNotFound =
                  this.onPageDefinitionNotFound)),
              this._sanitizePages(),
              this.interceptor &&
                "function" == typeof this.interceptor &&
                ((this.Router.channelManager = this.BridgeChannelManager),
                (this.Router.interceptor = this.interceptor)),
              (window.$core = window.$core || []),
              this.debug
                ? (window.$core.push(this), this.printDebugInfo())
                : window.$core.push({
                    log: function (e) {
                      return n.log(e);
                    },
                    ...
                    registerOutConnection: function (e, t, r, i) {
                      return n.registerOutConnection(e, t, r, i);
                    },
                    publish: function (e, t, r) {
                      return n.publish(e, t, r);
                    },
                    updateSubroute: function (e) {
                      return n.updateSubroute(e);
                    },
                    getCurrentRoute: function () {
                      return n.getCurrentRoute();
                    },
                    ...
                    updateFeatureFlagCollection: function (e) {
                      return n.updateFeatureFlagCollection(e);
                    },
                    getFeatureFlagCollection: function () {
                      return n.getFeatureFlagCollection();
                    },
                    ...
                    updateInterceptorContext: function (e) {
                      return n.updateInterceptorContext(e);
                    },
                    resetInterceptorContext: function () {
                      return n.resetInterceptorContext();
                    },
                    getInterceptorContext: function () {
                      return n.getInterceptorContext();
                    },
                    setInterceptorContext: function (e) {
                      return n.setInterceptorContext(e);
                    },
                  }),
              ...
              this.logs && this._logBridgeReady(),
              ...
              this.Router.start(),
              (this.navRequestListener = function (e) {
                ...
                var r = e.event,
                  ...
                  l = {};
                if (
                  (!o && i.paramPage && r.detail && (o = r.detail[i.paramPage]),
                  r.detail && a)
                )
                  for (var f in a)
                    r.detail.hasOwnProperty(f) && (l[a[f]] = r.detail[f]);
                s && n.Router.clearStackUntil(s),
                  n.Router.go(o, l, c, u),
                  Hi(n, t);
              }),
              to.on(r, this.navRequestListener),
              to.on(i, function (e) {
          ...
          return (
            Wi(e, [
                  ...
                  if (this.pages && !this.pageDefinitions) {
                    for (var t = 0; t < this.pages.length; t++)
                      this.pages[t] = {
                        name: this.pages[t],
                        type: Vs.STATIC,
                        adapter: this.onlyLitElements ? Hs.LIT_ELEMENT : void 0,
                        hasModules: !1,
                      };
                    ...
                    for (
                      var n = function (t) {
                          var n = e.pageDefinitions.findIndex(function (n) {
                            return n.name === e.pages[t];
                          });
                          n > -1
                            ? ((e.pageDefinitions[n].type =
                                e.pageDefinitions[n].type || Vs.STATIC),
                              (e.pages[t] = e.pageDefinitions[n]))
                            : ((e.pages[t] = {
                                name: e.pages[t],
                                type: Vs.STATIC,
                                adapter: e.onlyLitElements
                                  ? Hs.LIT_ELEMENT
                                  : void 0,
                                hasModules: !1,
                              }),
                              e.pageDefinitions.push(e.pages[t]));
                        },
                        r = 0;
                      r < this.pages.length;
                      r++
              ...
              },
              {
                key: "updateInterceptorContext",
                value: function (e) {
                  this.Router.updateInterceptorContext(e);
                },
              },
              {
              ...
              },
              {
                key: "setInterceptorContext",
                value: function (e) {
                  return this.Router.setInterceptorContext(e);
                },
              },
              {
                key: "updateFeatureFlagCollection",
                value: function (e) {
                  this.featureFlagCollection.update(e);
                },
              },
              {
              ...
              },
              {
                ...
                value: function () {
                  var e = this;
                  Array.isArray(window.cellsBridgeQueue) &&
                    (window.cellsBridgeQueue.forEach(function (t) {
                      var n = t.command,
                        r = t.parameters,
                        i = e[n];
                      return i
                        ? (console.log(
                            "Executing queued command ".concat(n, ".")
                          ),
                          void i.apply(e, r))
                        : void console.log(
                            "WARNING: Invalid cells bridge command execution: ".concat(
                              n,
                              " (QUEUE)."
                            )
                          );
              ...
              },
              {
                ...
                value: function () {
                  if (this.skipNavigations && this.skipNavigations.length > 0) {
                    for (var e = 0; e < this.skipNavigations.length; e++)
                      this.skipNavigations[e].skipHistory = !0;
              ...
              },
              {
                ...
                value: function (e) {
                  var t,
                    n = Us.VALUES;
                  return (t = n.indexOf(e) > -1 ? e : n[e] || qs);
                },
              },
              {
                key: "_dispatchEvent",
              ...
              },
              {
                ...
                value: function () {
                  ...
                  if (n) {
                    for (
                      var r = function () {
                          var t = e.externalEvents[i];
                          to.on(t, function (n) {
                            e._dispatchEvent(t, n), e.logs && e.monitor(t, n);
                          });
                        },
                        i = 0;
                      i < t;
              ...
              },
              {
                key: "log",
                value: function (e) {
                  this.hasApplicationLoggingEnabled() &&
                    this.monitoring.logApplication(e);
                },
              },
              {
                key: "logBridge",
                value: function (e) {
                  this.hasBridgeLoggingEnabled() &&
                    this.monitoring.logBridge(e);
                },
              },
              {
                key: "ingest",
                value: function (e) {
                  this.hasApplicationLoggingEnabled() &&
                    this.monitoring.ingest(e);
                },
              },
              {
                key: "createSpan",
                value: function (e) {
                  return this.hasApplicationLoggingEnabled()
                    ? this.monitoring.createSpan(e)
              ...
              },
              {
                ...
                value: function () {
                  ...
                  this.BridgeChannelManager.initEventChannels(
                    e,
                    this.externalEvents
                  ),
              ...
              },
              {
                ...
                value: function () {
                  var e = this.TemplateManager.computeTemplateId(
                  ...
                  t ||
                    (n
                      ? ((this.usingDeclarativeCrossContainer = !0),
                        this.TemplateManager.createTemplate(
                          this.crossContainerId,
                          { node: n }
                        ))
                      : ((t = this.TemplateManager.createTemplate(
                          this.crossContainerId,
                          { tagName: "div" }
                        )),
                  ...
                  e = Hi(
                    {
                      ...
                      Router: vu,
                      Sanitizer: Do,
                      BridgeChannelManager: Lu,
                      ActionChannelManager: Mu,
                      monitoring: ys,
                      featureFlagCollection: Ua,
                      PostMessageManager: bs,
                      ApplicationConfigManager: Ss,
                      ApplicationStateManager: Os,
                    },
                    e
                  );
                  for (var t in e)
                    e.hasOwnProperty(t) && (this[t] = new e[t](this));
                },
              },
              {
                key: "_initComposerEngine",
                value: function () {
                  (this.composerEngine = new Du(
                    this.ComponentConnector.manager,
                    composerEngine
                  )),
              ...
              },
              {
                ...
                value: function (e, t) {
                  var n = new bu(e, t);
                  return e.featureFlag && ds.extend(n, this), n;
                },
              },
              {
                ...
                value: function (e) {
                  var t = this.TemplateManager.get(this.crossContainerId),
                    n = e.properties.id,
                    r = n ? "#".concat(n) : e.tagName,
                    i = t.node.querySelector(r);
                  if (!i) {
                    var o = this._createCellsComponent(e, this);
                    return (
                      (o.__parentTemplate = t),
                      this.ComponentConnector.registerComponent(o),
                      this._ccRegister.push(
                        this._getCCData(o.node, o.connections)
                      ),
                      o
                    );
                  }
                  this._ccRegister.filter(function (e) {
                    return e.node === i;
                  }).length ||
                    this._ccRegister.push(this._getCCData(i, e.connections)),
                    this.ComponentConnector.progressiveRegisterConnections(
                      i,
                      e.connections
                    );
                },
              ...
              },
              {
                ...
                value: function (e) {
                  ...
                  return (
                    (r !== t && r !== n) ||
                      this.ComponentConnector.registerComponent(i),
                    i
                  );
                },
              },
              ...
              },
              {
                ...
                value: function (e, t) {
                  var n = this,
                    ...
                    o = e.page,
                    a = this,
                    u = this.Sanitizer.split(e.components),
                    s = this.createComponentsByType(u, t),
                    c = [],
                    l = [],
                    f = As("featureFlag");
                  s.map(function (e) {
                    return f(e.spec.connections);
                  }).forEach(
                    this.featureFlagCollection.add,
                    this.featureFlagCollection
                  );
                  ...
                  for (var h = 0, v = s.length; h < v; h++) {
                    s[h].setProps(), s[h].setAttrs();
                    var y = s[h],
                      d = y.__parentTemplate.name;
                    l[d] || (l[d] = this.TemplateManager.get(d)),
                      l[d].append(y);
                    var g =
                      this.ComponentConnector.adapterResolver.getComponentAdapter(
                        y
                      );
                    g.isUnresolved(y.node) && c.push(y);
                  }
                  switch (
                    (to.emit(i, {
                      page: o,
                    ...
                    case Bs.PROGRESSIVE:
                      ...
                      break;
                    case Bs.HERO:
                      this.selectTemplate(o, r),
                        this.ImportManager.loadComponentByPriority(
                          c,
                          a.componentsPath
                        );
                  }
              ...
              },
              {
                ...
                value: function (e) {
                  var t = e.name,
                    n = e.hasModules,
                    r = "".concat(t, "-page"),
                    i = this.TemplateManager.getNode(t);
                  if ((this.BridgeChannelManager.getPrivate(t), !i)) {
                    i = this.TemplateManager.createTemplate(t, { tagName: r });
                    var o =
                      this.ComponentConnector.adapterResolver.getAdapterByName(
                        e.adapter
                      );
                    if (o.isUnresolved(i.node)) {
                      if (e.adapter === Hs.POLYMER)
                        return this.loadPolymerWebComponent(t, n);
                      if (this.loadCellsPage) return this.loadCellsPage(t);
                    }
                  }
              ...
              },
              {
                ...
                value: function (e) {
                  ...
                  return (
                    this.composerEndpoint &&
                      this.remoteTemplates &&
                      (t = this.remoteTemplates.indexOf(e) === -1),
                    t
                  );
                },
              },
              {
                ...
                value: function (e) {
                  var t = this,
                    ...
                    a =
                      this.composerEngine &&
                      !this.PageManager._isLocalComposer(i);
                  this.BridgeChannelManager.getPrivate(i);
                  var u = this.getPageDefinition(i),
                    s = u.adapter;
                  if (!s) {
                    var c = [].concat(r.components || []);
                    c.push(r.template || {});
                    var l =
                        c.filter(function (e) {
                      ...
                      f =
                        c.filter(function (e) {
                          return "polymer" === e.render || void 0 === e.render;
                        }).length > 0;
                    f && !l
                      ? (s = Hs.POLYMER)
                      : !f && l && (s = Hs.LIT_ELEMENT);
                  }
                  var p = this.initialBundle.map(function (e) {
                      return e.replace(
                        /(\.js$|\.json$|-page(\.json|\.html)*)/,
                        ""
                      );
                    }),
                    h = p.indexOf(i) > -1;
                  return !n && this.preRenderingPages[i]
                    ? void (this.preRenderingPages[i] = Gs.REQUESTED)
                    : (o && !a
                        ? this.selectTemplate(i, n)
                        : r &&
                          r.template &&
                          (this.prplLevel === Bs.DEFER &&
                          this._isLocalTemplate(i) &&
                          !h
                            ? s === Hs.POLYMER
                              ...
                              : s === Hs.LIT_ELEMENT
                              ? this.loadCellsPage
                                ? this.loadCellsPage(i).then(function () {
                                    return t._createTemplateFromSpec(i, r, n);
                                  })
                                : this._createTemplateFromSpec(i, r, n)
                              : this.loadCellsPage
                              ? this.loadCellsPage(
                                  "".concat(i, "-modules")
                                ).then(function () {
                                  t.ImportManager.loadBundleForTemplate(
                                    t.componentsPath,
                                    i
                                  ).then(function () {
                                    t._createTemplateFromSpec(i, r, n);
              ...
              },
              {
                ...
                value: function (e, t) {
                  var n = this;
                  if (
                    (this.preCache === !0 || this.preRender === !0) &&
                    e.pages
                  )
                    for (var r in e.pages)
                      if (e.pages.hasOwnProperty(r)) {
                        var i = r === name || this.TemplateManager.cache[r];
                        if (i) continue;
                        this.preRender &&
                          t === !1 &&
                          (this.preRenderingPages[r] = Gs.WORKING),
                          this.loadTemplate(r).then(function (e) {
                            if (n.preRender && t === !1) {
                              var r = !0;
                              e.page
                                ? n._idleCallback(function () {
              ...
              },
              {
                ...
                value: function (e, t) {
                  ...
                  this.prplLevel === Bs.PROGRESSIVE &&
                    this.selectTemplate(e, r),
                    this.ComponentConnector.registerComponent(i),
                    t.pages && this.Router.addRoutes(t.pages);
                  var o =
                    this.ComponentConnector.adapterResolver.getComponentAdapter(
                      i
                    );
              ...
              },
              {
                ...
                value: function (e, t) {
                  return (
                    (e = xs("parse-" + e)),
                    "function" == typeof this[e] ? this[e](t) : t
                  );
                },
              },
              {
                ...
                value: function () {
                  var e = function (e, t) {
                    ...
                    return "background:".concat(
                      n,
                      "; color:#fff; padding:2px 4px; margin-right: 5px;"
                    );
                  };
                  console.log(
                    "%cbridge version: "
                      .concat(this.version, " %cbinding: ")
                      .concat(this.binding, " %cprplLevel: ")
                      .concat(this.prplLevel, " %ccache: ")
                      .concat(this.cache, " %cpreCache: ")
                      .concat(this.preCache, " %cpreRender: ")
                      .concat(this.preRender, " %clogs: ")
                      .concat(this.logs),
                    e(this.version, "#003f8d"),
                    e(this.binding, "#0065ba"),
                    e(this.prplLevel, "#008ff2"),
                    e(this.cache, "#0093e2"),
                    e(this.preCache, "#00aeeb"),
                    e(this.preRender, "#41cef8"),
                    e(this.logs, "#0025ad")
                  ),
                    this.id > 0 &&
                      console.log(
                        "%cWARNING: There are ".concat(
                          this.id + 1,
                          " simultaneous instances of the Bridge running."
                        ),
                        e(this.id, "#FF0000")
                      );
                },
              },
              {
                key: "routeHandler",
                value: function () {
                  var e = Ms.PARSE_ROUTE,
                    t = this.Router.currentRoute;
                  to.emit(e, t), this._handleRouteLoading(t);
                  for (var n in t.params) {
                    var r = {
                      detail: { value: t.params[n] },
                      type: Ts(n) + "-changed",
                    };
              ...
              },
              {
                ...
                value: function (e) {
                  var t = { name: e, type: Vs.DYNAMIC, adapter: Hs.POLYMER },
                    n = t,
                    r = this.pageDefinitions
                      .filter(Boolean)
                      .filter(function (t) {
                        return t.name === e;
                      });
                  return (
                    0 === r.length ? this.pageDefinitions.push(t) : (n = r[0]),
                    n
                  );
                },
              },
              {
                ...
                value: function (e, t) {
                  var n = this.cache,
                    ...
                    o = this.headers,
                    a = this.app,
                    u = this.templatesPath,
                    s = { cache: n, params: t, method: r, body: i, headers: o },
                    c = { app: a, templates: u };
                  return this.PageManager.get(e, s, c);
                },
              },
              {
              ...
              },
              {
                ...
                value: function (e) {
                  var t = this,
                    n = this.getPageDefinition(e.name);
                  n.type === Vs.STATIC
                    ? this.createPageFromWebComponent(n).then(function () {
              ...
              },
              {
                ...
                value: function (e, t) {
                  var n = Ms.TEMPLATE_REGISTERED,
                    r = js.UI,
                    i = this;
                  t &&
                    t !== e &&
                    this.unregisterChildren(t, i.binding === r ? "DM" : null),
                    this.registerChildren(e, i.binding === r ? "DM" : null),
                    this._updateChannels(t, e),
                    to.emit(n, { template: e.name });
                },
              },
              {
                key: "_updateChannels",
                value: function (e, t) {
                  if (this.BridgeChannelManager) {
                    var n = e ? e.name : void 0,
                      r = this.getInterceptorContext(),
                      i = this.getCurrentRoute();
              ...
              },
              {
                ...
                value: function (e, t) {
                  for (var n = 0; n < e.children.length; n++) {
                    var r = e.children[n];
                    ((t && t === r.type) || !t) &&
                      this.ComponentConnector.registerComponent(r);
                  }
                },
              },
              {
                ...
                value: function (e, t) {
                  for (var n = 0; n < e.children.length; n++) {
                    var r = e.children[n];
                    ((t && t === r.type) || !t) &&
                      this.ComponentConnector.unregisterComponent(r.node);
                  }
                },
              },
              {
              ...
              },
              {
                ...
                value: function (e, t, n, r) {
                  this.ComponentConnector.addPublication(e, t, n, r);
                },
              },
              {
                key: "unsubscribe",
                ...
                value: function (e, t) {
                  var n =
                      arguments.length > 2 && void 0 !== arguments[2]
                        ...
                        : {},
                    r = n.sessionStorage;
                  this.ComponentConnector.publish(e, t),
                    r === !0 && this.ApplicationStateManager.saveAppState(e, t);
                },
              },
              {
                ...
                value: function (e) {
                  ...
                  this.publish(r, e),
                    n === !0 && this.ApplicationConfigManager.saveAppConfig(e);
                },
              },
              {
                key: "updateSubroute",
                value: function (e) {
                  this.Router.updateSubrouteInBrowser(e);
                },
              },
              {
                key: "getCurrentRoute",
              ...
              { key: "navigateToNative", value: function (e, t) {} },
              {
                key: "backStep",
                value: function () {
                  var e = Ms.ROUTER_BACKSTEP;
                  to.emit(e, { event: {}, detail: {} });
                },
              },
              {
                        ...
                        return Bi().wrap(function (o) {
                          for (;;)
                            switch ((o.prev = o.next)) {
                              ...
                              case 2:
                                n._handleParams(i.node, t),
                                  (u = n.getInterceptorContext()),
                                  (s = n.getCurrentRoute()),
                                  n.TemplateManager.select(
                                    e,
                                    n.BridgeChannelManager,
                                    n.binding,
                                    u,
                                    s
                                  ),
                                  n.BridgeChannelManager &&
                                    n.BridgeChannelManager.updateBridgeChannels(
                                      a,
                                      e,
                                      u,
                                      s
                                    ),
                                  to.emit(r, { template: e });
                              case 8:
                              case "end":
                                return o.stop();
                            }
                ...
                value: function (e) {
                  var t = this,
                    n =
                      ...
                      void 0 !== arguments[1] &&
                      arguments[1],
                    r = Ms.TEMPLATE_TRANSITION_END,
                    i = js.CURRENTVIEW,
                    o = js.UI,
                    a = js.DELAYED,
                    u = this,
                    s = this.TemplateManager.get(e),
                    c = n !== !0 || this.preRenderingPages[e] === Gs.REQUESTED;
                  if ((u.binding === i || u.binding === o) && c) {
                    var l = this.TemplateManager.get(
                        this.TemplateManager.selected
                      ),
                      f = function () {
                        return t.registerCurrentTemplate(s, l);
                      };
                    s.node.animationCompleteEvent
                      ? to.listenToOnce(
                          s.node,
                          s.node.animationCompleteEvent,
                          f
                  ...
                  if (
                    (u.onRender &&
                      (s.fixedChildren.length > 0
                        ? u.onRender(s.node, s.fixedChildren)
                        : u.onRender(s.node)),
                    n && delete this.preRenderingPages[e],
                    c)
                  ) {
                    var p = this.getInterceptorContext(),
                      h = this.getCurrentRoute(),
                      v = function () {
                        return t.TemplateManager.select(
                          e,
                          t.BridgeChannelManager,
                          u.binding,
                          p,
                          h
                        );
                      };
                    u.binding === a ? this._idleCallback(v) : v();
                  }
                },
              },
              {
                key: "_idleCallback",
                value: function (e) {
                  this.BridgeChannelManager.getIdleCallbackChannel().subscribe(
                    e
                  );
                },
              },
              {
                key: "subscribeToEvent",
                value: function (e, t) {
                  if (this.externalEvents.indexOf(e) < 0)
                    return void console.warn(
                      "Trying to subscribe to a non existing event: ",
                      e
                    );
                  if ("function" != typeof t)
                    return void console.warn(
                      "You must provide a function callback to subscribe to the event: ",
                      e
                    );
                  var n = this.getMainNode();
                ...
                value: function () {
                  return (
                    this.__mainNodeElement ||
                      (this.__mainNodeElement = document.querySelector(
                        "#" + this.mainNode
                      )),
                    this.__mainNodeElement
                  );
              ...
              },
              {
                ...
                value: function (e, t) {
                  ...
                  null === r ||
                    void 0 === r ||
                    r.forEach(function (e) {
                      n.ComponentConnector.unregisterComponent(e.component, t);
                    }),
                    null === i ||
                      void 0 === i ||
                      i.forEach(function (e) {
                        n.ComponentConnector.unregisterComponent(
                          e.component,
                          t
                        );
                      });
                ...
                value: function (e) {
                  ...
                  null === n ||
                    ...
                    n.forEach(function (e) {
                      t.registerInConnection(e.channel, e.component, e.bind);
                    }),
                    null === r ||
                      void 0 === r ||
                      r.forEach(function (e) {
                        t.registerOutConnection(
                          e.channel,
                          e.component,
                          e.bind,
                          e.options
              ...
              },
              {
                ...
                value: function (e) {
                  ...
                  return e.filter(function (e) {
                    return (
                      0 ===
                      t._ccRegister.filter(function (t) {
                        return t.node === e.component;
                      }).length
                    );
                  });
                },
              ...
              {
                key: "_filterDynamicCrossComponents",
                value: function (e) {
                  (e.inConnections = this._filterdynamic(
                    e.inConnections || []
                  )),
                    (e.outConnections = this._filterdynamic(
                      e.outConnections || []
                    ));
                },
              },
              {
                key: "_cleanDynamicCrossComponents",
                value: function () {
                  this._ccRegister.forEach(function (e) {
              ...
              },
              {
                ...
                value: function () {
                  var e = !0,
                    t = this.TemplateManager.computeTemplateId(
                      this.crossContainerId
                    ),
                    n =
                  ...
                  this._disconnectCrossComponents(n, e),
                    this.BridgeChannelManager.resetBridgeChannels(
                      this.getMainNode(),
                      e
                    ),
                    this._filterDynamicCrossComponents(n),
                    this._cleanDynamicCrossComponents(),
                    this._reconnectCrossComponents(n);
                },
              },
              {
                key: "logout",
                value: function () {
                  this.TemplateManager.selected !== this.initialTemplate &&
                    ...
                    this.usingDeclarativeCrossContainer ||
                      this.TemplateManager.removeTemplateChildrens(
                        this.crossContainerId
                      ),
                    this.TemplateManager.removeTemplates(
                      void 0,
                    ...
                    this.ActionChannelManager.subscribeAll(),
                    this._addInitialSubscribersToEvents(),
                    this.composerEngine && this.composerEngine.reset(),
