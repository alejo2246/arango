...
(function (B, ya) {
  "object" === typeof module && "object" === typeof module.exports
    ...
    : ya(B);
})("undefined" !== typeof window ? window : this, function (B, ya) {
  function za(a) {
  ...
  function Aa(a) {
    var b = {};
    c.each(a.match(qa) || [], function (d, e) {
      b[e] = !0;
    });
    return b;
  }
  function Qb() {
    C.addEventListener
      ? (C.removeEventListener("DOMContentLoaded", Ba),
        B.removeEventListener("load", Ba))
      : (C.detachEvent("onreadystatechange", Ba), B.detachEvent("onload", Ba));
  }
  function Ba() {
    if (
      C.addEventListener ||
  ...
  function Wb(a, b, d, e, f) {
    for (
      var g, k, m, p, q, t, v = a.length, A = Vb(b), Q = [], L = 0;
      L < v;
      L++
    )
      if ((k = a[L]) || 0 === k)
    ...
    m && A.removeChild(m);
    y.appendChecked || c.grep(ea(Q, "input"), Uc);
    for (L = 0; (k = Q[L++]); )
      if (e && -1 < c.inArray(k, e)) f && f.push(k);
      else if (
        ((a = c.contains(k.ownerDocument, k)),
        (m = ea(A.appendChild(k), "script")),
        a && sb(m),
        d)
      )
  ...
  function Fa(a, b, d, e) {
    ...
    var f,
      ...
      p = b[0],
      q = c.isFunction(p);
    if (q || (1 < k && "string" === typeof p && !y.checkClone && Xc.test(p)))
    ...
    if (k) {
      ...
      if (v || e) {
        var A = c.map(ea(t, "script"), bc);
        for (f = A.length; g < k; g++)
          (v = t),
            g !== m &&
              ((v = c.clone(v, !0, !0)), f && c.merge(A, ea(v, "script"))),
            d.call(a[g], v, g);
        if (f)
          for (
            t = A[A.length - 1].ownerDocument, c.map(A, cc), g = 0;
            g < f;
            g++
          )
            (v = A[g]),
  ...
  function nc(a, b, d, e, f) {
    ...
    for (var g = 0; 4 > b; b += 2)
      "margin" === d && (g += c.css(a, d + Ga[b], !0, f)),
        e
          ? ("content" === d && (g -= c.css(a, "padding" + Ga[b], !0, f)),
            "margin" !== d &&
              (g -= c.css(a, "border" + Ga[b] + "Width", !0, f)))
          : ((g += c.css(a, "padding" + Ga[b], !0, f)),
            "padding" !== d &&
              (g += c.css(a, "border" + Ga[b] + "Width", !0, f)));
    return g;
  }
  function oc(a, b, d) {
    var e = !0,
      ...
      g = Oa(a),
      k = y.boxSizing && "border-box" === c.css(a, "boxSizing", !1, g);
    if (0 >= f || null == f) {
      f = Ha(a, b, g);
      if (0 > f || null == f) f = a.style[b];
      if (db.test(f)) return f;
      e = k && (y.boxSizingReliable() || f === a.style[b]);
      f = parseFloat(f) || 0;
    }
  ...
  function qc(a, b, d) {
    for (
      var e,
        f = (ma.tweeners[b] || []).concat(ma.tweeners["*"]),
        g = 0,
        k = f.length;
      g < k;
      g++
  ...
  function ma(a, b, d) {
    var e,
      ...
      m = function () {
        ...
        for (
          var t = 1 - (q / p.duration || 0), v = 0, A = p.tweens.length;
          v < A;
          v++
        )
          p.tweens[v].run(t);
    ...
    for ($c(d, p.opts.specialEasing); f < g; f++)
      if ((b = ma.prefilters[f].call(p, a, d, p.opts)))
        return (
          c.isFunction(b.stop) &&
  ...
  c.extend({
    ...
    isPlainObject: function (a) {
      ...
      if (!y.ownFirst) for (b in a) return Qa.call(a, b);
      for (b in a);
    ...
    each: function (a, b) {
      var d,
        e = 0;
      if (za(a)) for (d = a.length; e < d && !1 !== b.call(a[e], e, a[e]); e++);
    ...
    proxy: function (a, b) {
      ...
      if (c.isFunction(a)) {
        var e = Ca.call(arguments, 2);
        d = function () {
          return a.apply(b || this, e.concat(Ca.call(arguments)));
        };
  ...
  var Ta = (function (a) {
    function b(h, n, l, r) {
      ...
      if (
        !r &&
        ((n ? n.ownerDocument || n : O) !== G && Ja(n), (n = n || G), R)
      ) {
        if (11 !== F && (D = hd.exec(h)))
          if ((u = D[1]))
            if (9 === F)
              ...
              if (z && (x = z.getElementById(u)) && la(n, x) && x.id === u)
                return l.push(x), l;
            }
          else {
            if (D[2]) return Da.apply(l, n.getElementsByTagName(h)), l;
            if (
              (u = D[3]) &&
              S.getElementsByClassName &&
              n.getElementsByClassName
            )
              return Da.apply(l, n.getElementsByClassName(u)), l;
          }
        if (!(!S.qsa || ba[h + " "] || (N && N.test(h)))) {
          if (1 !== F) {
            ...
            for (x = wc.test(w) ? "#" + w : "[id\x3d'" + w + "']"; u--; )
              D[u] = x + " " + A(D[u]);
            K = D.join(",");
            z = (Cb.test(h) && t(n.parentNode)) || n;
          }
          if (K)
            try {
              return Da.apply(l, z.querySelectorAll(K)), l;
            } catch (E) {
            } finally {
    ...
    function Q(h, n, l) {
      ...
      return n.first
        ? function (w, D, z) {
            for (; (w = w[r]); ) if (1 === w.nodeType || u) return h(w, D, z);
          }
        : function (w, D, z) {
            var F,
              K = [Y, x];
            if (z)
              for (; (w = w[r]); ) {
                if ((1 === w.nodeType || u) && h(w, D, z)) return !0;
              }
            else
              for (; (w = w[r]); )
                if (1 === w.nodeType || u) {
    ...
    function ja(h, n, l, r, u) {
      for (var x, w = [], D = 0, z = h.length, F = null != n; D < z; D++)
    ...
    function ia(h, n, l, r, u, x) {
      ...
      return e(function (w, D, z, F) {
        ...
        if (!(X = w)) {
          X = n || "*";
          for (
            var H = z.nodeType ? [z] : z, ra = [], V = 0, ib = H.length;
            V < ib;
            V++
          )
            b(X, H[V], ra);
        ...
        X = !h || (!w && n) ? X : ja(X, E, h, z, F);
        H = l ? (u || (w ? h : Z || r) ? [] : D) : X;
        l && l(X, H, z, F);
        if (r) {
          var oa = ja(H, T);
          r(oa, [], z, F);
          for (z = oa.length; z--; ) if ((K = oa[z])) H[T[z]] = !(X[T[z]] = K);
        }
        if (w) {
          if (u || h) {
            if (u) {
              oa = [];
              for (z = H.length; z--; ) (K = H[z]) && oa.push((X[z] = K));
              u(null, (H = []), oa, F);
            }
            for (z = H.length; z--; )
              (K = H[z]) &&
        ...
        } else (H = ja(H === D ? H.splice(Z, H.length) : H)), u ? u(null, D, H, F) : Da.apply(D, H);
      });
    }
    function fa(h) {
      var n,
      ...
      var l = 0 < n.length,
        ...
        u = function (x, w, D, z, F) {
          var K,
            ...
            ra = ca,
            V = x || (r && P.find.TAG("*", F)),
            ib = (Y += null == ra ? 1 : Math.random() || 0.1),
            oa = V.length;
          for (
            F && (ca = w === G || w || F);
            Z !== oa && null != (K = V[Z]);
          ...
          if (l && Z !== T) {
            ...
            if (x) {
              if (0 < T) for (; Z--; ) X[Z] || H[Z] || (H[Z] = kd.call(z));
              H = ja(H);
            }
            Da.apply(z, H);
            F && !x && 0 < H.length && 1 < T + n.length && b.uniqueSort(z);
          }
          F && ((Y = ib), (ca = ra));
          return X;
        };
    ...
    try {
      Da.apply((ua = xc.call(O.childNodes)), O.childNodes),
        ua[O.childNodes.length].nodeType;
    } catch (h) {
      Da = {
        apply: ua.length
          ? function (n, l) {
    ...
    var Ja = (b.setDocument = function (h) {
      var n;
      ...
      Ra = n
        ? function (l, r) {
            ...
            return u & 1 ||
              ...
              ? l === G || (l.ownerDocument === O && la(O, l))
                ? -1
                : r === G || (r.ownerDocument === O && la(O, r))
                ? 1
                : J
                ? Ka(J, l) - Ka(J, r)
                : 0
        ...
        : function (l, r) {
            ...
            for (l = r; (l = l.parentNode); ) z.unshift(l);
            for (; D[u] === z[u]; ) u++;
            return u ? k(D[u], z[u]) : D[u] === O ? -1 : z[u] === O ? 1 : 0;
          };
      return G;
    });
    ...
    b.attr = function (h, n) {
      ...
      l = l && Sa.call(P.attrHandle, n.toLowerCase()) ? l(h, n, !R) : void 0;
      return void 0 !== l
        ? l
        : S.attributes || !R
        ? h.getAttribute(n)
    ...
    var P = (b.selectors = {
      ...
      preFilter: {
        ATTR: function (h) {
          h[1] = h[1].replace(va, wa);
          h[3] = (h[3] || h[4] || h[5] || "").replace(va, wa);
          "~\x3d" === h[2] && (h[3] = " " + h[3] + " ");
          return h.slice(0, 4);
        },
        CHILD: function (h) {
      ...
      filter: {
        TAG: function (h) {
          var n = h.replace(va, wa).toLowerCase();
          return "*" === h
            ? function () {
                return !0;
              }
                    ...
                    for (; F; ) {
                      for (E = z; (E = E[F]); )
                        if (
                          ...
                          return !1;
                      var ra = (F = "only" === h && !ra && "nextSibling");
                    }
                    return !0;
                  }
                  ra = [w ? Z.firstChild : Z.lastChild];
                  if (w && K) {
                    E = Z;
                    var V = E[M] || (E[M] = {});
                    ...
                    for (
                      E = T && Z.childNodes[T];
                      (E = (++T && E && E[F]) || (H = T = 0) || ra.pop());

                    )
                      if (1 === E.nodeType && ++H && E === z) {
                        V[h] = [Y, T, H];
                        break;
                      }
                  } else if (
        ...
        PSEUDO: function (h, n) {
          ...
          if (1 < l.length) {
            ...
            return P.setFilters.hasOwnProperty(h.toLowerCase())
              ? e(function (u, x) {
                  for (var w, D = l(u, n), z = D.length; z--; )
                    (w = Ka(u, D[z])), (u[w] = !(x[w] = D[z]));
                })
              : function (u) {
                  return l(u, 0, r);
                };
    ...
    var gb = (b.tokenize = function (h, n) {
      var l, r, u, x, w;
      if ((x = sa[h + " "])) return n ? 0 : x.slice(0);
      x = h;
      var D = [];
      for (w = P.preFilter; x; ) {
        if (!z || (l = nd.exec(x)))
        ...
        if ((l = od.exec(x)))
          (z = l.shift()),
            r.push({ value: z, type: l[0].replace(hb, " ") }),
            (x = x.slice(z.length));
        for (u in P.filter)
          !(l = kb[u].exec(x)) ||
            (w[u] && !(l = w[u](l))) ||
            ((z = l.shift()),
            r.push({ value: z, type: u, matches: l }),
            (x = x.slice(z.length)));
        if (!z) break;
      }
      return n ? x.length : x ? b.error(h) : sa(h, D).slice(0);
    });
    ...
    var jd = (b.select = function (h, n, l, r) {
      var u,
        ...
        z = !r && gb((h = D.selector || h));
      l = l || [];
      if (1 === z.length) {
        var F = (z[0] = z[0].slice(0));
        if (
          2 < F.length &&
          "ID" === (x = F[0]).type &&
          S.getById &&
          ...
          n = (P.find.ID(x.matches[0].replace(va, wa), n) || [])[0];
          if (!n) return l;
          D && (n = n.parentNode);
        ...
        for (u = kb.needsContext.test(h) ? 0 : F.length; u--; ) {
          ...
          if ((w = P.find[w]))
            if (
              (r = w(
                x.matches[0].replace(va, wa),
                (Cb.test(F[0].type) && t(n.parentNode)) || n
              ))
            ) {
              F.splice(u, 1);
              h = r.length && A(F);
              if (!h) return Da.apply(l, r), l;
              break;
            }
        }
      }
      (D || zc(h, z))(r, n, !R, l, !n || (Cb.test(h) && t(n.parentNode)) || n);
      return l;
    });
    S.sortStable = M.split("").sort(Ra).join("") === M;
  ...
  c.uniqueSort = c.unique = Ta.uniqueSort;
  c.text = Ta.getText;
  c.isXMLDoc = Ta.isXML;
  c.contains = Ta.contains;
  ...
  c.fn.extend({
    ...
    filter: function (a) {
      return this.pushStack(Wa(this, a || [], !1));
    },
    not: function (a) {
      return this.pushStack(Wa(this, a || [], !0));
    },
    is: function (a) {
      return !!Wa(
        this,
  ...
  c.each(
    {
      ...
      nextUntil: function (a, b, d) {
        return Ua(a, "nextSibling", d);
      },
      prevUntil: function (a, b, d) {
        return Ua(a, "previousSibling", d);
      },
      siblings: function (a) {
  ...
  c.Callbacks = function (a) {
    a = "string" === typeof a ? Aa(a) : c.extend({}, a);
    var b,
      d,
      e,
      f,
            ...
            (function A(v) {
              c.each(v, function (Q, L) {
                c.isFunction(L)
                  ...
                  : L && L.length && "string" !== c.type(L) && A(L);
              });
            })(arguments),
            d && !b && p());
          return this;
    ...
    when: function (a) {
      var b = 0,
        ...
        k = function (t, v, A) {
          return function (Q) {
            v[t] = this;
            A[t] = 1 < arguments.length ? Ca.call(arguments) : Q;
            A === p ? g.notifyWith(v, A) : --f || g.resolveWith(v, A);
          };
        },
        m;
      if (1 < e) {
  ...
  c.ready.promise = function (a) {
    if (!lb)
      if (
        ...
        B.setTimeout(c.ready);
      else if (C.addEventListener)
        C.addEventListener("DOMContentLoaded", Ba),
          B.addEventListener("load", Ba);
      else {
        C.attachEvent("onreadystatechange", Ba);
        B.attachEvent("onload", Ba);
        var b = !1;
        try {
          b = null == B.frameElement && C.documentElement;
        } catch (d) {}
        b &&
          b.doScroll &&
          (function e() {
  ...
  c(function () {
    ...
    if ((a = C.getElementsByTagName("body")[0]) && a.style) {
      ...
      "undefined" !== typeof b.style.zoom &&
        ...
        (y.inlineBlockNeedsLayout = b = 3 === b.offsetWidth)) &&
        (a.style.zoom = 1);
      a.removeChild(d);
    }
  });
  ...
  var Fb = /[+-]?(?:\d*\.|)\d+(?:[eE][+-]?\d+|)/.source,
    ...
    Ea = function (a, b, d, e, f, g, k) {
      var m = 0,
        p = a.length,
        q = null == d;
      if ("object" === c.type(d))
        for (m in ((f = !0), d)) Ea(a, b, m, d[m], !0, g, k);
      else if (
        void 0 !== e &&
        ((f = !0),
        c.isFunction(e) || (k = !0),
  ...
  (function () {
    ...
    y.leadingWhitespace = 3 === a.firstChild.nodeType;
    y.tbody = !a.getElementsByTagName("tbody").length;
    y.htmlSerialize = !!a.getElementsByTagName("link").length;
    y.html5Clone =
    ...
    d.checked = !0;
    b.appendChild(d);
    y.appendChecked = d.checked;
    a.innerHTML = "\x3ctextarea\x3ex\x3c/textarea\x3e";
    y.noCloneChecked = !!a.cloneNode(!0).lastChild.defaultValue;
    a.innerHTML = "\x3coption\x3e\x3c/option\x3e";
    y.option = !!a.lastChild;
    b.appendChild(a);
    d = C.createElement("input");
    ...
    a.appendChild(d);
    y.checkClone = a.cloneNode(!0).cloneNode(!0).lastChild.checked;
    y.noCloneEvent = !!a.addEventListener;
    a[c.expando] = 1;
    y.attributes = !a.getAttribute(c.expando);
  })();
  var ka = {
  ...
  (function () {
    ...
    for (a in { submit: !0, change: !0, focusin: !0 }) {
      var d = "on" + a;
      (y[a] = d in B) ||
        (b.setAttribute(d, "t"), (y[a] = !1 === b.attributes[d].expando));
    }
  })();
  ...
  c.event = {
    ...
    add: function (a, b, d, e, f) {
      ...
      if ((k = c._data(a))) {
        ...
        for (k = b.length; k--; ) {
          ...
          A &&
            ((v = c.event.special[A] || {}),
            (A = (f ? v.delegateType : v.bindType) || A),
            (v = c.event.special[A] || {}),
            (p = c.extend(
              {
                type: A,
            ...
            (q = g[A]) ||
              ...
              (v.setup && !1 !== v.setup.call(a, e, Q, m)) ||
                (a.addEventListener
                  ? a.addEventListener(A, m, !1)
                  : a.attachEvent && a.attachEvent("on" + A, m))),
            v.add &&
    ...
    remove: function (a, b, d, e, f) {
      ...
      if (t && (p = t.events)) {
        ...
        for (m = b.length; m--; ) {
          ...
          var Q = (v[2] || "").split(".").sort();
          if (A) {
            var L = c.event.special[A] || {};
            A = (e ? L.delegateType : L.bindType) || A;
            var ja = p[A] || [];
            v =
              v[2] &&
              new RegExp("(^|\\.)" + Q.join("\\.(?:.*\\.|)") + "(\\.|$)");
            for (k = g = ja.length; g--; ) {
              ...
              (!f && q !== ia.origType) ||
                ...
                (ja.splice(g, 1),
                ia.selector && ja.delegateCount--,
                L.remove && L.remove.call(a, ia));
            }
            k &&
              !ja.length &&
              ((L.teardown && !1 !== L.teardown.call(a, Q, t.handle)) ||
                c.removeEvent(a, A, t.handle),
              delete p[A]);
          } else for (A in p) c.event.remove(a, A + b[m], d, e, !0);
        }
    ...
    trigger: function (a, b, d, e) {
      var f,
        g,
        k = [d || C],
        m = Qa.call(a, "type") ? a.type : a;
      var p = Qa.call(a, "namespace") ? a.namespace.split(".") : [];
      var q = (f = d = d || C);
      if (
        3 !== d.nodeType &&
        8 !== d.nodeType &&
        ...
        if (e || !p.trigger || !1 !== p.trigger.apply(d, b)) {
          if (!e && !p.noBubble && !c.isWindow(d)) {
            ...
            f === (d.ownerDocument || C) &&
              k.push(f.defaultView || f.parentWindow || B);
          }
        ...
        for (f = 0; null != (e = p[f]); ++f)
          if (m[f]) {
            ...
            if (1 === v.nodeType) {
              ...
              else if ("input" === A && tb.test(t.type))
        ...
        function (b) {
          ...
          if (
            !(
              "string" !== typeof b ||
              Bd.test(b) ||
              (!y.htmlSerialize && Gc.test(b)) ||
              (!y.leadingWhitespace && ub.test(b)) ||
              ka[(Xb.exec(b) || ["", ""])[1].toLowerCase()]
            )
          ) {
            b = c.htmlPrefilter(b);
            try {
  ...
  (function () {
    function a() {
      ...
      if (B.getComputedStyle) {
        ...
        p.style.width = "1px";
        g = !parseFloat((B.getComputedStyle(t) || {}).marginRight);
        p.removeChild(t);
      }
    ...
    p.style &&
      ...
      (y.opacity = "0.5" === p.style.opacity),
      (y.cssFloat = !!p.style.cssFloat),
  ...
  if (B.getComputedStyle) {
    ...
    var Ha = function (a, b, d) {
      var e = a.style;
      var f = (d = d || Oa(a)) ? d.getPropertyValue(b) || d[b] : void 0;
      ("" !== f && void 0 !== f) ||
        c.contains(a.ownerDocument, a) ||
        (f = c.style(a, b));
      if (d && !y.pixelMarginRight() && db.test(f) && Hc.test(b)) {
        a = e.width;
        b = e.minWidth;
        var g = e.maxWidth;
  ...
  c.extend({
    cssHooks: {
      opacity: {
        get: function (a, b) {
          if (b) return (a = Ha(a, "opacity")), "" === a ? "1" : a;
        },
      },
    },
    cssNumber: {
        ...
        return mc(
          ...
          f
            ? nc(
                ...
                b,
                f,
                y.boxSizing && "border-box" === c.css(d, "boxSizing", !1, g),
                g
              )
            : 0
        );
  ...
  c.cssHooks.marginRight = wb(y.reliableMarginRight, function (a, b) {
    if (b) return Ib(a, { display: "inline-block" }, Ha, [a, "marginRight"]);
  });
  c.cssHooks.marginLeft = wb(y.reliableMarginLeft, function (a, b) {
    if (b)
      return (
  ...
  c.Animation = c.extend(ma, {
    ...
    tweener: function (a, b) {
      c.isFunction(a) ? ((b = a), (a = ["*"])) : (a = a.match(qa));
      for (var d, e = 0, f = a.length; e < f; e++)
        (d = a[e]),
          (ma.tweeners[d] = ma.tweeners[d] || []),
          ma.tweeners[d].unshift(b);
    },
    prefilters: [
      function (a, b, d) {
        var e,
        ...
        if (1 === a.nodeType && ("height" in b || "width" in b)) {
          ...
          var A = "none" === v ? c._data(a, "olddisplay") || cb(a.nodeName) : v;
          "inline" === A &&
            "none" === c.css(a, "float") &&
            (y.inlineBlockNeedsLayout && "inline" !== cb(a.nodeName)
              ? (k.zoom = 1)
  ...
  c.fx.interval = 13;
  c.fx.start = function () {
    mb || (mb = B.setInterval(c.fx.tick, c.fx.interval));
  };
  c.fx.stop = function () {
    B.clearInterval(mb);
    mb = null;
  ...
  c.extend({
    ...
    attrHooks: {
      type: {
        set: function (a, b) {
          if (!y.radioValue && "radio" === b && c.nodeName(a, "input")) {
            var d = a.value;
  ...
  var Kd = {
    set: function (a, b, d) {
      !1 === b
        ? c.removeAttr(a, d)
        : (nb && Ma) || !Kb.test(d)
        ? a.setAttribute((!Ma && c.propFix[d]) || d, d)
  ...
  c.fn.extend({
    addClass: function (a) {
      ...
      if (c.isFunction(a))
        return this.each(function (p) {
          c(this).addClass(a.call(this, p, Ia(this)));
        });
      if ("string" === typeof a && a)
        for (b = a.match(qa) || []; (d = this[k++]); ) {
          var m = Ia(d);
    ...
    removeClass: function (a) {
      ...
      if (c.isFunction(a))
        return this.each(function (p) {
          c(this).removeClass(a.call(this, p, Ia(this)));
        });
    ...
    toggleClass: function (a, b) {
      ...
      return "boolean" === typeof b && "string" === d
        ...
        ? this.each(function (e) {
            c(this).toggleClass(a.call(this, e, Ia(this), b), b);
          })
        : this.each(function () {
            var e, f;
            if ("string" === d) {
              var g = 0;
              var k = c(this);
              for (f = a.match(qa) || []; (e = f[g++]); )
                k.hasClass(e) ? k.removeClass(e) : k.addClass(e);
            } else if (void 0 === a || "boolean" === d) (e = Ia(this)) && c._data(this, "__className__", e), c.attr(this, "class", e || !1 === a ? "" : c._data(this, "__className__") || "");
          });
    },
    hasClass: function (a) {
      var b,
  ...
  c.parseXML = function (a) {
    ...
    try {
      if (B.DOMParser) {
        var b = new B.DOMParser();
        var d = b.parseFromString(a, "text/xml");
      } else
        (d = new B.ActiveXObject("Microsoft.XMLDOM")),
          (d.async = "false"),
          d.loadXML(a);
    } catch (e) {
      d = void 0;
      ...
      function d(J, U, G, W) {
        ...
        if (2 !== fa) {
          ...
          if (G) {
            var N = q;
            for (
              var aa = I, da, la, M, O, Y = N.contents, na = N.dataTypes;
              "*" === na[0];

            )
              na.shift(),
                void 0 === la &&
                  (la = N.mimeType || aa.getResponseHeader("Content-Type"));
            if (la)
              for (O in Y)
                if (Y[O] && Y[O].test(la)) {
                  na.unshift(O);
            ...
            M ? (M !== na[0] && na.unshift(M), (N = G[M])) : (N = void 0);
          }
          a: {
            G = q;
            da = N;
            ...
            for (O = Y.shift(); O; ) {
              G.responseFields[O] && (la[G.responseFields[O]] = da);
              !sa && M && G.dataFilter && (da = G.dataFilter(da, G.dataType));
              var sa = O;
              if ((O = Y.shift()))
                if ("*" === O) O = sa;
                else if ("*" !== sa && sa !== O) {
          ...
          else if (((Sa = R), J || !R)) (R = "error"), 0 > J && (J = 0);
          I.status = J;
          I.statusText = (U || R) + "";
          W ? A.resolveWith(t, [Ra, R, I]) : A.rejectWith(t, [I, R, Sa]);
          I.statusCode(L);
          L = void 0;
          k && v.trigger(W ? "ajaxSuccess" : "ajaxError", [I, q, W ? Ra : Sa]);
          Q.fireWith(t, [I, R]);
          k &&
  ...
  y.cors = !!pb && "withCredentials" in pb;
  (pb = y.ajax = !!pb) &&
  ...
  c.ajaxPrefilter("json jsonp", function (a, b, d) {
    ...
    if (f || "jsonp" === a.dataTypes[0]) {
      ...
      d.always(function () {
        void 0 === k ? c(B).removeProp(g) : (B[g] = k);
  ...
  c.each(["top", "left"], function (a, b) {
    c.cssHooks[b] = wb(y.pixelPosition, function (d, e) {
      if (e) return (e = Ha(d, b)), db.test(e) ? c(d).position()[b] + "px" : e;
    });
  });
...
(function (B) {
  ...
  B.htmlPrefilter = function (pa) {
    ...
    Aa !== pa &&
      ya(pa) !== ya(Aa) &&
      console.error("HTML tags must be properly nested and closed: " + pa);
    return Wa(pa);
  };
})(window.jQuery);
